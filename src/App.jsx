...
const BASE_CITIES = [
  ...
  { id:351, name:"Cergy", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.0360°N, 2.0630°E", funFact:"Cergy est une ville nouvelle construite à partir de 1969 dans le Val-d'Oise, à 30 km de Paris. Elle abrite l'ESSEC, une des meilleures business schools de France, et son parc naturel régional est le plus grand espace vert d'Île-de-France avec 80 km de voies vertes.", costs:{logement:750,courses:130,restos:95,nocturne:60,transport:75,sante:50,telecom:22,voyage:120} },
  { id:352, name:"Lyon", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.7640°N, 4.8357°E", funFact:"Lyon est la capitale mondiale de la gastronomie et possède plus de restaurants étoilés Michelin par habitant que Paris. La ville est également le berceau du cinéma — les frères Lumière y ont réalisé le premier film de l'histoire en 1895.", costs:{logement:820,courses:135,restos:105,nocturne:75,transport:70,sante:52,telecom:22,voyage:130} },
  { id:353, name:"Marseille", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.2965°N, 5.3698°E", funFact:"Marseille est la plus vieille ville de France, fondée par les Grecs en 600 avant J.-C. sous le nom de Massalia. La bouillabaisse, sa soupe de poisson emblématique, a été créée par des pêcheurs qui cuisinaient les poissons invendables — et est maintenant un plat gastronomique.", costs:{logement:700,courses:125,restos:90,nocturne:65,transport:65,sante:48,telecom:21,voyage:120} },
  { id:354, name:"Toulouse", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6047°N, 1.4442°E", funFact:"Toulouse est surnommée la Ville Rose pour ses briques en terre cuite rose. Elle est aussi la capitale européenne de l'aéronautique : Airbus y fabrique ses avions et le Concorde y a été construit. Toulouse abrite la plus grande concentration d'ingénieurs en Europe.", costs:{logement:750,courses:128,restos:95,nocturne:68,transport:68,sante:49,telecom:21,voyage:125} },
  { id:355, name:"Bordeaux", country:"France", flag:"🇫🇷", continent:"Europe", coords:"44.8378°N, 0.5792°O", funFact:"Bordeaux possède le plus grand ensemble de bâtiments classés monuments historiques en France après Paris. La ville produit les vins les plus prestigieux du monde et son port de la Lune est classé UNESCO. La place de la Bourse et son miroir d'eau sont devenus iconiques.", costs:{logement:780,courses:130,restos:98,nocturne:70,transport:65,sante:50,telecom:22,voyage:125} },
  { id:356, name:"Lille", country:"France", flag:"🇫🇷", continent:"Europe", coords:"50.6292°N, 3.0573°E", funFact:"Lille est à 1h de Paris, 35 minutes de Bruxelles et 1h20 de Londres en Eurostar. La Braderie de Lille est la plus grande braderie d'Europe — 10 000 exposants et 2 millions de visiteurs chaque premier week-end de septembre.", costs:{logement:680,courses:122,restos:88,nocturne:62,transport:62,sante:47,telecom:21,voyage:110} },
  { id:357, name:"Nantes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.2184°N, 1.5536°O", funFact:"Nantes a été élue Capitale Verte de l'Europe 2013. La ville abrite les Machines de l'Île, des créatures mécaniques géantes inspirées de Jules Verne et Leonardo da Vinci — dont un éléphant de 12 mètres qui se promène en ville.", costs:{logement:740,courses:126,restos:92,nocturne:65,transport:63,sante:49,telecom:21,voyage:118} },
  { id:358, name:"Montpellier", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6108°N, 3.8767°E", funFact:"Montpellier est la ville française avec la plus jeune population — 30 % de ses habitants ont moins de 25 ans grâce à ses 7 universités. C'est aussi la ville qui croît le plus vite en France depuis 30 ans. Sa faculté de médecine est la plus ancienne du monde encore en activité.", costs:{logement:720,courses:124,restos:90,nocturne:67,transport:63,sante:48,telecom:21,voyage:118} },
  { id:359, name:"Strasbourg", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.5734°N, 7.7521°E", funFact:"Strasbourg est le siège du Parlement Européen et du Conseil de l'Europe — une ville symbole de la réconciliation franco-allemande. Son marché de Noël est le plus ancien de France (1570) et la cathédrale de Strasbourg a été la plus haute construction du monde pendant 233 ans.", costs:{logement:760,courses:128,restos:94,nocturne:65,transport:65,sante:50,telecom:22,voyage:120} },
  { id:360, name:"Nice", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.7102°N, 7.2620°E", funFact:"Nice a été italienne jusqu'en 1860 — sa cuisine mêle influences françaises et niçoises avec la socca, la pissaladière et la salade niçoise. La Promenade des Anglais a été payée par des aristocrates britanniques qui finançaient des travaux pour donner du travail aux pauvres en hiver.", costs:{logement:900,courses:138,restos:108,nocturne:78,transport:68,sante:53,telecom:22,voyage:135} },
  { id:361, name:"Rennes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.1173°N, 1.6778°O", funFact:"Rennes est surnommée la capitale de la Bretagne, même si Brest est géographiquement plus bretonne. La ville est l'une des plus dynamiques de France pour les startups tech et abrite le plus grand campus universitaire de l'Ouest.", costs:{logement:730,courses:125,restos:90,nocturne:63,transport:62,sante:48,telecom:21,voyage:115} },
  { id:362, name:"Grenoble", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.1885°N, 5.7245°E", funFact:"Grenoble est entourée par trois massifs montagneux — Chartreuse, Belledonne et Vercors — visible depuis n'importe quel point de la ville. C'est la capitale mondiale des sports d'hiver et le premier fabricant de gants au monde.", costs:{logement:720,courses:124,restos:89,nocturne:62,transport:62,sante:48,telecom:21,voyage:120} },
  { id:363, name:"Glasgow", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"55.8642°N, 4.2518°O", funFact:"Glasgow est la ville la plus peuplée d'Écosse et a une des scènes musicales les plus vivantes d'Europe — on y a vu naître Travis, Franz Ferdinand et Primal Scream. Elle est aussi connue pour ses habitants extrêmement chaleureux, souvent désignés comme les plus accueillants du Royaume-Uni.", costs:{logement:780,courses:138,restos:112,nocturne:82,transport:90,sante:55,telecom:28,voyage:165} },
  { id:364, name:"Édimbourg", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"55.9533°N, 3.1883°O", funFact:"Édimbourg accueille chaque août le plus grand festival des arts du monde — le Festival Fringe — avec 50 000 représentations en 25 jours. La ville est aussi la source d'inspiration de Harry Potter : J.K. Rowling écrivait dans des cafés d'Édimbourg en regardant le château.", costs:{logement:900,courses:148,restos:120,nocturne:88,transport:95,sante:58,telecom:28,voyage:170} },
  { id:365, name:"Bristol", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"51.4545°N, 2.5879°O", funFact:"Bristol est la ville natale de Banksy, l'artiste de street art le plus célèbre du monde — et ses œuvres parsèment encore les murs de la ville. Bristol a été la première ville au Royaume-Uni à adopter sa propre monnaie locale, le Bristol Pound.", costs:{logement:850,courses:142,restos:115,nocturne:85,transport:88,sante:56,telecom:28,voyage:162} },
  { id:366, name:"Manchester", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"53.4808°N, 2.2426°O", funFact:"Manchester est le berceau de la Révolution Industrielle et du football moderne — les règles du football y ont été codifiées en 1863. La ville abrite aussi deux des clubs les plus riches du monde (United et City) et a produit Oasis, The Smiths, Joy Division et Elbow.", costs:{logement:820,courses:140,restos:113,nocturne:83,transport:88,sante:56,telecom:28,voyage:162} },
  { id:367, name:"Bilbao", country:"Espagne", flag:"🇪🇸", continent:"Europe", coords:"43.2630°N, 2.9350°O", funFact:"Bilbao a été transformée grâce au Musée Guggenheim inauguré en 1997 — l'effet Guggenheim est devenu un modèle mondial de régénération urbaine par la culture. La ville est aussi la capitale gastronomique de l'Espagne avec le plus grand nombre de pintxos bars au monde.", costs:{logement:720,courses:118,restos:98,nocturne:78,transport:45,sante:42,telecom:19,voyage:145} },
  { id:368, name:"Malaga", country:"Espagne", flag:"🇪🇸", continent:"Europe", coords:"36.7213°N, 4.4214°O", funFact:"Malaga est la ville natale de Pablo Picasso — son musée natal est l'un des plus visités d'Espagne. La Costa del Sol bénéficie de 320 jours de soleil par an et Malaga est en train de devenir la nouvelle capitale tech de l'Espagne, attirant des startups du monde entier.", costs:{logement:680,courses:112,restos:88,nocturne:68,transport:38,sante:40,telecom:18,voyage:138} },
  { id:369, name:"Valladolid", country:"Espagne", flag:"🇪🇸", continent:"Europe", coords:"41.6523°N, 4.7245°O", funFact:"Valladolid a été la capitale de l'Espagne avant Madrid et c'est là que Christophe Colomb est mort en 1506, convaincu jusqu'au bout d'avoir atteint les Indes. La ville possède le plus grand musée de sculpture polychrome au monde.", costs:{logement:520,courses:95,restos:72,nocturne:55,transport:28,sante:35,telecom:17,voyage:118} },
  { id:370, name:"Palerme", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"38.1157°N, 13.3615°E", funFact:"Palerme est une des villes les plus multiculturelle d'Europe, ayant été successivement dominée par Grecs, Romains, Arabes, Normands et Espagnols — chaque civilisation laissant son empreinte architecturale. Les catacombes des Capucins y conservent 8 000 corps momifiés.", costs:{logement:550,courses:105,restos:80,nocturne:58,transport:28,sante:38,telecom:17,voyage:135} },
  { id:371, name:"Naples", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"40.8518°N, 14.2681°E", funFact:"Naples a inventé la pizza — la vraie, celle de la Margherita créée en 1889 en l'honneur de la reine Margherite de Savoie. La ville est aussi au pied du Vésuve, le seul volcan actif d'Europe continentale, avec 3 millions de personnes vivant dans la zone de danger.", costs:{logement:600,courses:112,restos:85,nocturne:62,transport:32,sante:40,telecom:17,voyage:138} },
  { id:372, name:"Turin", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"45.0703°N, 7.6869°E", funFact:"Turin a été la première capitale d'Italie en 1861 et est la ville du Suaire de Turin — le tissu que certains croient être celui qui a enveloppé le Christ. C'est aussi la capitale mondiale de l'automobile : Fiat, Alfa Romeo et Lancia y sont nées.", costs:{logement:700,courses:118,restos:94,nocturne:68,transport:40,sante:44,telecom:19,voyage:138} },
  { id:373, name:"Florence", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"43.7696°N, 11.2558°E", funFact:"Florence possède plus d'œuvres d'art par m² que n'importe quelle ville au monde. Le Syndrome de Stendhal — un malaise provoqué par une surcharge de beauté artistique — a été cliniquement observé pour la première fois ici.", costs:{logement:780,courses:126,restos:110,nocturne:72,transport:38,sante:46,telecom:19,voyage:145} },
  { id:374, name:"Bologne", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"44.4949°N, 11.3426°E", funFact:"Bologne abrite la plus ancienne université du monde, fondée en 1088. La ville a aussi inventé la sauce bolognaise — sauf que la vraie recette n'a pas de spaghettis mais des tagliatelles. C'est pourquoi les habitants la surnomment 'La Dotta, La Grassa, La Rossa'.", costs:{logement:720,courses:118,restos:96,nocturne:68,transport:36,sante:44,telecom:19,voyage:138} },
  { id:375, name:"Gênes", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"44.4056°N, 8.9463°E", funFact:"Gênes est la ville natale de Christophe Colomb et a été la plus grande puissance maritime de la Méditerranée au Moyen Âge. Son centre historique est le plus grand d'Europe et son pesto est si emblématique qu'il est protégé par une appellation d'origine.", costs:{logement:650,courses:112,restos:88,nocturne:60,transport:34,sante:42,telecom:18,voyage:132} },
  { id:376, name:"Cologne", country:"Allemagne", flag:"🇩🇪", continent:"Europe", coords:"50.9333°N, 6.9500°E", funFact:"La cathédrale de Cologne a pris 632 ans à construire (1248-1880) et est la troisième plus haute église du monde. L'eau de Cologne a été inventée ici en 1709 par un parfumeur italien — et le carnaval de Cologne est le plus grand d'Allemagne avec 1,5 million de participants.", costs:{logement:820,courses:132,restos:105,nocturne:75,transport:82,sante:50,telecom:22,voyage:148} },
  { id:377, name:"Hambourg", country:"Allemagne", flag:"🇩🇪", continent:"Europe", coords:"53.5753°N, 10.0153°E", funFact:"Hambourg est la ville avec le plus de millionnaires en Allemagne et son port est le troisième plus grand d'Europe. La Reeperbahn, son quartier de divertissement nocturne, était le terrain de jeu des Beatles qui y ont joué pendant 2 ans avant de devenir célèbres.", costs:{logement:950,courses:140,restos:112,nocturne:85,transport:90,sante:52,telecom:23,voyage:155} },
  { id:378, name:"Munich", country:"Allemagne", flag:"🇩🇪", continent:"Europe", coords:"48.1351°N, 11.5820°E", funFact:"Munich abrite l'Oktoberfest, la plus grande fête de la bière au monde avec 6 millions de visiteurs en 16 jours. BMW, Siemens et Allianz y ont leur siège et la ville est régulièrement classée parmi les 10 villes les plus agréables à vivre en Europe.", costs:{logement:1100,courses:148,restos:118,nocturne:88,transport:92,sante:54,telecom:23,voyage:158} },
  { id:379, name:"Francfort", country:"Allemagne", flag:"🇩🇪", continent:"Europe", coords:"50.1109°N, 8.6821°E", funFact:"Francfort est le centre financier de l'Europe continentale et abrite la Banque Centrale Européenne. C'est aussi la ville natale de Goethe et le plus grand carrefour aéroportuaire d'Europe. Son skyline de gratte-ciels lui vaut le surnom de 'Mainhattan'.", costs:{logement:980,courses:142,restos:114,nocturne:82,transport:88,sante:52,telecom:23,voyage:150} },
  { id:380, name:"Düsseldorf", country:"Allemagne", flag:"🇩🇪", continent:"Europe", coords:"51.2217°N, 6.7762°E", funFact:"Düsseldorf est la capitale mondiale de la mode après Paris, Milan et New York — elle accueille deux fois par an la plus grande foire de mode au monde. La ville abrite aussi la plus grande communauté japonaise d'Europe et son Altbier brun est une fierté locale.", costs:{logement:890,courses:136,restos:108,nocturne:78,transport:85,sante:51,telecom:22,voyage:148} },
  { id:381, name:"Bruxelles", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"50.8503°N, 4.3517°E", funFact:"Bruxelles abrite les sièges de l'Union Européenne et de l'OTAN — c'est la capitale politique du monde occidental. La ville compte plus de 1 000 sortes de bières différentes et a inventé la frite (et non la France). Le Manneken Pis, sa statue iconique, est habillé 30 fois par an.", costs:{logement:880,courses:135,restos:108,nocturne:78,transport:72,sante:51,telecom:22,voyage:145} },
  { id:382, name:"Gand", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"51.0543°N, 3.7174°E", funFact:"Gand est la seule ville au monde où le jeudi est le jour sans viande officiel depuis 2009 — une initiative adoptée par la ville entière pour réduire son empreinte carbone. Son centre médiéval intact avec ses tours et canaux en fait l'une des plus belles villes flamandes.", costs:{logement:720,courses:120,restos:95,nocturne:68,transport:60,sante:46,telecom:21,voyage:130} },
  { id:383, name:"Bruges", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"51.2093°N, 3.2247°E", funFact:"Bruges est si bien conservée qu'elle semble figée au Moyen Âge — son centre historique est classé UNESCO. La ville possède un pipeline souterrain de bière de 3 km reliant la brasserie au centre d'embouteillage, construit après que les riverains ont refusé le passage des camions.", costs:{logement:750,courses:122,restos:98,nocturne:65,transport:55,sante:46,telecom:21,voyage:130} },
  { id:384, name:"Lausanne", country:"Suisse", flag:"🇨🇭", continent:"Europe", coords:"46.5197°N, 6.6323°E", funFact:"Lausanne est la capitale mondiale du sport — le Comité International Olympique y a son siège ainsi que 55 fédérations sportives internationales. La ville est construite en terrasses sur les bords du lac Léman avec vue sur les Alpes, et son métro automatique est le plus petit du monde.", costs:{logement:1600,courses:220,restos:198,nocturne:148,transport:110,sante:80,telecom:40,voyage:230} },
  { id:385, name:"Genève", country:"Suisse", flag:"🇨🇭", continent:"Europe", coords:"46.2044°N, 6.1432°E", funFact:"Genève abrite le CERN, la plus grande machine du monde — le LHC — qui a permis de découvrir le boson de Higgs. L'ONU, la Croix-Rouge, l'OMS et 200 autres organisations internationales y ont leur siège. C'est aussi là qu'a été inventé le World Wide Web en 1989.", costs:{logement:1700,courses:232,restos:210,nocturne:155,transport:115,sante:85,telecom:42,voyage:240} },
  { id:386, name:"Porto Alegre", country:"Brésil", flag:"🇧🇷", continent:"Amérique du Sud", coords:"30.0346°S, 51.2177°O", funFact:"Porto Alegre est la capitale du Rio Grande do Sul, l'État le plus au sud du Brésil, où la culture gaucha (cow-boys locaux) est encore vivante. La ville est connue pour ses churrascos et son chimarrão (maté chaud), et a inventé le budget participatif municipal copié dans 1 500 villes du monde.", costs:{logement:380,courses:82,restos:55,nocturne:45,transport:18,sante:28,telecom:12,voyage:168} },
  { id:387, name:"Medellín", country:"Colombie", flag:"🇨🇴", continent:"Amérique du Sud", coords:"6.2476°N, 75.5658°O", funFact:"Medellín était la ville la plus violente du monde en 1991 — et est devenue en 20 ans un modèle mondial de transformation urbaine. Elle a remporté le prix de la ville la plus innovante du monde en 2013. Son métrocâble relie les quartiers défavorisés perchés sur les collines au centre-ville.", costs:{logement:350,courses:78,restos:48,nocturne:40,transport:15,sante:28,telecom:11,voyage:155} },
  { id:388, name:"Quito", country:"Équateur", flag:"🇪🇨", continent:"Amérique du Sud", coords:"0.1807°S, 78.4678°O", funFact:"Quito est la capitale la plus haute du monde à 2 850 m d'altitude et la première ville classée patrimoine mondial de l'UNESCO en 1978. Elle est littéralement sur l'Équateur — à quelques km de la ligne zéro — et son centre colonial est le mieux préservé d'Amérique Latine.", costs:{logement:320,courses:72,restos:45,nocturne:38,transport:14,sante:25,telecom:10,voyage:148} },
  { id:389, name:"Asunción", country:"Paraguay", flag:"🇵🇾", continent:"Amérique du Sud", coords:"25.2867°S, 57.6470°O", funFact:"Asunción est une des capitales les moins chères du monde et une des plus sous-estimées. Le paraguayen parle espagnol et guarani (langue indigène) dans la même phrase — le pays entier est bilingue. La ville est connue pour sa décontraction légendaire et son yerba maté.", costs:{logement:280,courses:65,restos:40,nocturne:32,transport:12,sante:22,telecom:9,voyage:158} },
  { id:390, name:"Montevideo", country:"Uruguay", flag:"🇺🇾", continent:"Amérique du Sud", coords:"34.9011°S, 56.1645°O", funFact:"Montevideo est régulièrement classée ville avec la meilleure qualité de vie en Amérique Latine. L'Uruguay est le premier pays au monde à avoir légalisé le cannabis à l'échelle nationale. La ville possède la plus grande promenade balnéaire d'Amérique du Sud : la Rambla de 22 km.", costs:{logement:420,courses:88,restos:60,nocturne:48,transport:18,sante:30,telecom:13,voyage:195} },
  { id:391, name:"La Paz", country:"Bolivie", flag:"🇧🇴", continent:"Amérique du Sud", coords:"16.5000°S, 68.1193°O", funFact:"La Paz est la capitale gouvernementale la plus haute du monde à 3 640 m — si haute que les visiteurs souffrent souvent du mal de l'altitude. Son téléphérique urbain Mi Teleférico est le plus long et le plus élevé du monde avec 11 lignes couvrant 31 km.", costs:{logement:260,courses:62,restos:38,nocturne:30,transport:10,sante:20,telecom:8,voyage:155} },
  { id:392, name:"Vancouver", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"49.2827°N, 123.1207°O", funFact:"Vancouver est si pittoresque qu'elle a servi de décor pour plus de 200 films et séries TV — surnommée Hollywood du Nord. La ville borde à la fois l'océan Pacifique et les montagnes enneigées, permettant de skier le matin et de surfer l'après-midi.", costs:{logement:1400,courses:175,restos:155,nocturne:105,transport:95,sante:72,telecom:48,voyage:235} },
  { id:393, name:"Ottawa", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"45.4215°N, 75.6972°O", funFact:"Ottawa possède la plus longue patinoire du monde — le canal Rideau gelé de 7,8 km classé UNESCO. La ville est parfaitement bilingue (anglais/français) et abrite certains des meilleurs musées gratuits au monde, dont le Musée des Civilisations.", costs:{logement:1050,courses:162,restos:140,nocturne:95,transport:88,sante:68,telecom:45,voyage:210} },
  { id:394, name:"Calgary", country:"Canada", flag:"🇨🇦", continent:"Europe", coords:"51.0447°N, 114.0719°O", funFact:"Calgary est la porte d'entrée des Rocheuses canadiennes et a accueilli les JO d'hiver 1988. La ville a le salaire moyen le plus élevé du Canada et son Stampede, le plus grand rodéo du monde, attire 1,2 million de visiteurs chaque juillet.", costs:{logement:1100,courses:168,restos:145,nocturne:98,transport:90,sante:70,telecom:46,voyage:220} },
  { id:395, name:"Guadalajara", country:"Mexique", flag:"🇲🇽", continent:"Amérique du Nord", coords:"20.6597°N, 103.3496°O", funFact:"Guadalajara est le berceau de la tequila, du mariachi et de la charrería (rodéo mexicain) — les trois éléments les plus iconiques de la culture mexicaine. La ville est aussi la Silicon Valley du Mexique avec le plus grand cluster tech du pays.", costs:{logement:420,courses:88,restos:58,nocturne:50,transport:18,sante:30,telecom:12,voyage:148} },
  { id:396, name:"Casablanca", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"33.5731°N, 7.5898°O", funFact:"Casablanca est le centre économique du Maroc et abrite la mosquée Hassan II, la 3ème plus grande mosquée du monde avec un minaret de 210 m visible de 30 km en mer. La ville du film éponyme de Bogart n'y a pourtant jamais été tournée — tout a été filmé à Hollywood.", costs:{logement:380,courses:85,restos:55,nocturne:48,transport:20,sante:30,telecom:12,voyage:125} },
  { id:397, name:"Marrakech", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"31.6295°N, 7.9811°O", funFact:"Marrakech est surnommée la Ville Rouge pour ses remparts en pisé couleur ocre. La place Djemaa el-Fna est le seul site culturel immatériel classé UNESCO au monde. Les souks de la médina sont un labyrinthe de 3 000 ruelles où il est impossible de ne pas se perdre.", costs:{logement:320,courses:75,restos:48,nocturne:42,transport:15,sante:25,telecom:10,voyage:118} },
  { id:398, name:"Tunis", country:"Tunisie", flag:"🇹🇳", continent:"Afrique", coords:"36.8065°N, 10.1815°E", funFact:"Tunis est construite à côté des ruines de Carthage, l'empire qui défia Rome pendant 3 guerres puniques. La médina de Tunis est classée UNESCO et ses souks sont les plus authentiques d'Afrique du Nord. La Tunisie est le pays arabe le plus tourné vers l'Europe culturellement.", costs:{logement:280,courses:65,restos:40,nocturne:35,transport:12,sante:22,telecom:8,voyage:105} },
  { id:399, name:"Dakar", country:"Sénégal", flag:"🇸🇳", continent:"Afrique", coords:"14.7167°N, 17.4677°O", funFact:"Dakar est le point le plus occidental du continent africain — si proche de l'Amérique que le Rallye Dakar y partait. La ville est la capitale culturelle de l'Afrique de l'Ouest avec la scène musicale la plus vibrante du continent.", costs:{logement:300,courses:68,restos:42,nocturne:35,transport:12,sante:22,telecom:9,voyage:165} },
  { id:400, name:"Abidjan", country:"Côte d'Ivoire", flag:"🇨🇮", continent:"Afrique", coords:"5.3600°N, 4.0083°O", funFact:"Abidjan est la capitale économique de l'Afrique de l'Ouest et le plus grand centre financier de la sous-région. La ville possède une architecture moderniste des années 1960-70 unique en Afrique, héritée de son statut de vitrine du miracle ivoirien.", costs:{logement:350,courses:72,restos:45,nocturne:38,transport:14,sante:25,telecom:10,voyage:170} },
  { id:401, name:"Accra", country:"Ghana", flag:"🇬🇭", continent:"Afrique", coords:"5.6037°N, 0.1870°O", funFact:"Accra est l'une des villes africaines les plus développées et les plus stables politiquement. Le Ghana a été le premier pays subsaharien à obtenir son indépendance en 1957 sous Kwame Nkrumah. La scène afrobeats d'Accra rayonne dans le monde entier.", costs:{logement:320,courses:70,restos:43,nocturne:36,transport:13,sante:23,telecom:9,voyage:158} },
  { id:402, name:"Kampala", country:"Ouganda", flag:"🇺🇬", continent:"Afrique", coords:"0.3476°N, 32.5825°E", funFact:"Kampala est construite sur 7 collines et est l'une des villes d'Afrique qui croît le plus vite. L'Ouganda possède la population la plus jeune du monde avec 78 % de moins de 30 ans. Le lac Victoria, juste à côté, est la plus grande source du Nil.", costs:{logement:260,courses:58,restos:35,nocturne:28,transport:10,sante:18,telecom:7,voyage:165} },
  { id:403, name:"Dar es Salaam", country:"Tanzanie", flag:"🇹🇿", continent:"Afrique", coords:"6.8235°S, 39.2695°E", funFact:"Dar es Salaam signifie 'Maison de la Paix' en arabe et est le plus grand port d'Afrique de l'Est. La Tanzanie abrite le Kilimandjaro (plus haute montagne d'Afrique), le Serengeti et Zanzibar — trois des destinations les plus iconiques du continent.", costs:{logement:280,courses:62,restos:38,nocturne:30,transport:11,sante:20,telecom:8,voyage:175} },
  { id:404, name:"Kathmandu", country:"Népal", flag:"🇳🇵", continent:"Asie", coords:"27.7172°N, 85.3240°E", funFact:"Kathmandu est la porte d'entrée de l'Everest et des 8 000 mètres himalayens. La ville possède 7 sites UNESCO dans un rayon de 20 km, dont des stupas bouddhistes de 2 000 ans. Des millions de pèlerins y viennent chaque année depuis les quatre coins du monde.", costs:{logement:240,courses:55,restos:32,nocturne:25,transport:8,sante:18,telecom:6,voyage:168} },
  { id:405, name:"Tbilissi", country:"Géorgie", flag:"🇬🇪", continent:"Asie", coords:"41.6938°N, 44.8015°E", funFact:"Tbilissi est l'une des destinations les plus tendance en Europe depuis 5 ans. La Géorgie a inventé le vin il y a 8 000 ans — les kvevri (jarres en terre cuite enterrées) sont classées UNESCO. La scène clubbing de Tbilissi (Bassiani) est classée parmi les 5 meilleures au monde.", costs:{logement:380,courses:78,restos:50,nocturne:42,transport:15,sante:25,telecom:9,voyage:145} },
  { id:406, name:"Erevan", country:"Arménie", flag:"🇦🇲", continent:"Asie", coords:"40.1872°N, 44.5152°E", funFact:"Erevan est l'une des plus vieilles villes habitées du monde avec 2 800 ans d'histoire — plus vieille que Rome. L'Arménie a été le premier pays à adopter le christianisme comme religion d'État en 301. Depuis un point de la ville, le mont Ararat (symbole national) est visible en Turquie voisine.", costs:{logement:320,courses:70,restos:44,nocturne:38,transport:14,sante:22,telecom:8,voyage:138} },
  { id:407, name:"Bakou", country:"Azerbaïdjan", flag:"🇦🇿", continent:"Asie", coords:"40.4093°N, 49.8671°E", funFact:"Bakou est surnommée la Ville des Vents et est la capitale la plus basse du monde à 28 m sous le niveau de la mer. Son vieux centre Itcherisheher est classé UNESCO avec des murailles de 5 000 ans. Les feux éternels du Yanar Dag brûlent depuis l'Antiquité grâce au gaz naturel.", costs:{logement:350,courses:72,restos:46,nocturne:38,transport:13,sante:23,telecom:8,voyage:148} },
  { id:408, name:"Almaty", country:"Kazakhstan", flag:"🇰🇿", continent:"Asie", coords:"43.2220°N, 76.8512°E", funFact:"Almaty était la capitale du Kazakhstan jusqu'en 1997 et reste la ville la plus cosmopolite du pays. À seulement 30 km, les montagnes Tian Shan permettent de skier avec vue sur les steppes. La pomme (Malus sieversii) vient génétiquement d'ici — le nom 'Alma-Ata' signifie 'père des pommes'.", costs:{logement:380,courses:80,restos:52,nocturne:42,transport:15,sante:25,telecom:10,voyage:168} },
  { id:409, name:"Tachkent", country:"Ouzbékistan", flag:"🇺🇿", continent:"Asie", coords:"41.2995°N, 69.2401°E", funFact:"Tachkent est la plus grande ville d'Asie Centrale avec 3 millions d'habitants. La ville est à mi-chemin sur la Route de la Soie entre Samarcande et Boukhara. Son métro soviétique est le plus décoré du monde avec des stations qui ressemblent à des palais.", costs:{logement:260,courses:58,restos:35,nocturne:28,transport:8,sante:18,telecom:6,voyage:155} },
  { id:410, name:"Hanoï", country:"Vietnam", flag:"🇻🇳", continent:"Asie", coords:"21.0278°N, 105.8342°E", funFact:"Hanoï est l'une des plus vieilles capitales d'Asie avec 1 000 ans d'histoire. La rue des 36 corporations (Vieux Quartier) était organisée par métier au XIVème siècle — une rue pour les marchands de soie, une pour les orfèvres... La pho bo y est une institution nationale consommée au petit déjeuner.", costs:{logement:380,courses:78,restos:45,nocturne:40,transport:15,sante:28,telecom:10,voyage:165} },
  { id:411, name:"Ho Chi Minh-Ville", country:"Vietnam", flag:"🇻🇳", continent:"Asie", coords:"10.8231°N, 106.6297°E", funFact:"Hô Chi Minh-Ville (Saigon) est la ville la plus dynamique du Vietnam avec 9 millions d'habitants et une économie qui croît de 8 % par an. La ville compte plus de 9 millions de motos — traverser la rue est une expérience culturelle. Les tunnels de Củ Chi, à côté, font 250 km sous la ville.", costs:{logement:400,courses:82,restos:48,nocturne:42,transport:16,sante:30,telecom:11,voyage:168} },
  { id:412, name:"Phnom Penh", country:"Cambodge", flag:"🇰🇭", continent:"Asie", coords:"11.5564°N, 104.9282°E", funFact:"Phnom Penh est une ville en pleine transformation — après les horreurs des Khmers Rouges, elle est devenue une des villes qui croît le plus vite en Asie. Le Palais Royal et les marchés locaux coexistent avec une scène café et art contemporain florissante.", costs:{logement:280,courses:60,restos:35,nocturne:30,transport:10,sante:18,telecom:7,voyage:155} },
  { id:413, name:"Vientiane", country:"Laos", flag:"🇱🇦", continent:"Asie", coords:"17.9757°N, 102.6331°E", funFact:"Vientiane est probablement la capitale la plus calme d'Asie du Sud-Est — sans gratte-ciels ni embouteillages, elle ressemble plus à une ville de province française qu'à une capitale asiatique. Le Laos est le pays le plus bombardé de l'histoire au km² — les bombes non explosées des années 1960 jonchent encore les campagnes.", costs:{logement:260,courses:55,restos:32,nocturne:25,transport:9,sante:16,telecom:6,voyage:148} },
  { id:414, name:"Colombo", country:"Sri Lanka", flag:"🇱🇰", continent:"Asie", coords:"6.9271°N, 79.8612°E", funFact:"Colombo est en pleine renaissance après des années de guerre civile et une crise économique sévère en 2022. Le Sri Lanka produit 23 % du thé mondial et son ceylan est le thé noir le plus consommé au monde. L'île possède 8 sites UNESCO dont la forteresse du Lion de Sigiriya.", costs:{logement:300,courses:65,restos:40,nocturne:32,transport:12,sante:20,telecom:8,voyage:148} },
  { id:415, name:"Yangon", country:"Myanmar", flag:"🇲🇲", continent:"Asie", coords:"16.8661°N, 96.1951°E", funFact:"Yangon est dominée par la Shwedagon Pagoda, un stupa de 98 mètres plaqué de 60 tonnes d'or et recouvert de milliers de diamants et rubis. La ville est l'une des mieux préservées d'architecture coloniale en Asie du Sud-Est.", costs:{logement:280,courses:58,restos:32,nocturne:25,transport:9,sante:16,telecom:6,voyage:150} },
  { id:416, name:"Ulaanbaatar", country:"Mongolie", flag:"🇲🇳", continent:"Asie", coords:"47.8864°N, 106.9057°E", funFact:"Oulan-Bator est la capitale la plus froide du monde avec une moyenne annuelle de -1.3°C. La Mongolie est le pays le moins dense de la planète (2 personnes/km²) et 30 % de la population est encore nomade. La ville porte le nom de 'Héros Rouge' — Ulaanbaatar en mongol.", costs:{logement:300,courses:65,restos:40,nocturne:32,transport:12,sante:20,telecom:8,voyage:195} },
  { id:417, name:"Karachi", country:"Pakistan", flag:"🇵🇰", continent:"Asie", coords:"24.8607°N, 67.0011°E", funFact:"Karachi est l'une des plus grandes villes du monde avec 16 millions d'habitants et est le centre économique du Pakistan générant 25 % du PIB national. La ville est un incroyable melting-pot de cultures avec des biryani réputés dans tout le sous-continent indien.", costs:{logement:220,courses:52,restos:28,nocturne:20,transport:8,sante:15,telecom:5,voyage:148} },
  { id:418, name:"Dhaka", country:"Bangladesh", flag:"🇧🇩", continent:"Asie", coords:"23.8103°N, 90.4125°E", funFact:"Dhaka est l'une des villes les plus densément peuplées du monde avec 44 000 habitants/km². Le Bangladesh est le 2ème exportateur mondial de vêtements et 90 % de la production de rickshaws du monde vient de Dhaka — la ville en compte 900 000.", costs:{logement:200,courses:48,restos:25,nocturne:18,transport:7,sante:14,telecom:5,voyage:142} },
  { id:419, name:"Auckland", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"36.8485°S, 174.7633°E", funFact:"Auckland est construite sur un champ volcanique de 53 volcans — le dernier en activité il y a seulement 600 ans. La ville est régulièrement classée parmi les plus agréables à vivre au monde et 38 % de ses habitants sont nés à l'étranger, en faisant une des plus cosmopolites d'Océanie.", costs:{logement:1200,courses:172,restos:148,nocturne:95,transport:90,sante:70,telecom:38,voyage:288} },
  { id:420, name:"Christchurch", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"43.5321°S, 172.6362°E", funFact:"Christchurch a été partiellement détruite par des séismes en 2010-2011 et s'est reconstruite de façon innovante — avec des bâtiments temporaires en containers colorés qui sont devenus une attraction touristique. La ville est la porte d'entrée de l'Antarctique.", costs:{logement:1000,courses:162,restos:138,nocturne:88,transport:82,sante:65,telecom:35,voyage:272} },
  { id:421, name:"Brisbane", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"27.4698°S, 153.0251°E", funFact:"Brisbane accueille les Jeux Olympiques d'été 2032 et connaît la plus forte croissance de toutes les grandes villes australiennes. Le Sunshine Coast et la Gold Coast bordent la ville, et le bush australien avec ses kangourous est accessible en 30 minutes de voiture.", costs:{logement:1050,courses:168,restos:142,nocturne:90,transport:82,sante:66,telecom:34,voyage:278} },
  { id:422, name:"Perth", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"31.9505°S, 115.8605°E", funFact:"Perth est la ville la plus isolée du monde — la plus proche, Adelaide, est à 2 700 km. Paradoxalement, Perth est aussi l'une des villes les plus ensoleillées de la planète avec 3 000 heures de soleil par an. Elle est plus proche de Singapour que de Sydney.", costs:{logement:1100,courses:170,restos:145,nocturne:92,transport:84,sante:67,telecom:34,voyage:280} },
  { id:423, name:"Adélaïde", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"34.9285°S, 138.6007°E", funFact:"Adélaïde est surnommée 'la ville des 1 000 lieux de culte' pour ses nombreuses églises victoriennes. Elle a la réputation d'être la ville australienne la plus décontractée et boit plus de vin par habitant que tout autre État australien — la vallée de Barossa est à 60 km.", costs:{logement:950,courses:162,restos:138,nocturne:88,transport:80,sante:64,telecom:33,voyage:270} },
  { id:424, name:"Nadi", country:"Fidji", flag:"🇫🇯", continent:"Océanie", coords:"17.8000°S, 177.4167°E", funFact:"Nadi est la porte d'entrée des 333 îles fidjiennes et le hub aérien du Pacifique Sud. Les Fidji sont connues comme le pays du sourire — les habitants sont régulièrement classés parmi les plus heureux du monde. Le kava, boisson rituelle à base de poivre, est consommé lors de toutes les cérémonies.", costs:{logement:350,courses:95,restos:68,nocturne:45,transport:18,sante:28,telecom:12,voyage:280} },
  { id:425, name:"Reims", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.2583°N, 4.0317°E", funFact:"Reims est la ville du sacre des rois de France — 33 rois y ont été couronnés dans sa cathédrale gothique classée UNESCO. La région produit le champagne (AOP), dont Reims est la capitale mondiale. Les caves cathédrales creusées dans la craie s'étendent sur 250 km sous la ville.", costs:{logement:650,courses:120,restos:88,nocturne:60,transport:60,sante:47,telecom:21,voyage:112} },
  { id:426, name:"Dijon", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.3220°N, 5.0415°E", funFact:"Dijon est la capitale mondiale de la moutarde — la moutarde de Dijon est protégée par une appellation géographique. La ville est aussi au cœur de la Bourgogne, la région qui produit les vins de Bourgogne, Chablis et Côte de Nuits parmi les plus chers du monde.", costs:{logement:680,courses:118,restos:88,nocturne:60,transport:58,sante:46,telecom:21,voyage:110} },
  { id:427, name:"Aix-en-Provence", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.5297°N, 5.4474°E", funFact:"Aix-en-Provence est la ville de Cézanne — le peintre qui a révolutionné l'art moderne en représentant la montagne Sainte-Victoire plus de 80 fois. La ville est surnommée la 'Ville des Mille Fontaines' et son marché de la place Richelme est l'un des plus beaux de France.", costs:{logement:820,courses:132,restos:100,nocturne:68,transport:62,sante:50,telecom:22,voyage:120} },
  { id:428, name:"Annecy", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.8992°N, 6.1294°E", funFact:"Annecy est surnommée la Venise des Alpes pour ses canaux et sa vieille ville au bord du lac le plus pur d'Europe. Le lac d'Annecy est si propre qu'on peut y boire l'eau directement. La ville est entourée de sommets alpins et bénéficie de 2 500 heures de soleil par an.", costs:{logement:850,courses:136,restos:102,nocturne:65,transport:62,sante:50,telecom:22,voyage:122} },
  { id:429, name:"Brest", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.3896°N, 4.4861°O", funFact:"Brest est la ville la plus à l'ouest de la France continentale et son arsenal militaire est le plus grand chantier naval de France. Elle est aussi la capitale maritime de la Bretagne avec le plus grand aquarium d'eau tempérée de la planète (Océanopolis).", costs:{logement:620,courses:115,restos:82,nocturne:58,transport:56,sante:44,telecom:20,voyage:108} },
  { id:430, name:"Tours", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.3941°N, 0.6848°E", funFact:"Tours est au cœur du Val de Loire, classé UNESCO, surnommé le Jardin de la France. La ville parle le français le plus pur et mélodieux du pays selon l'Académie française. Les châteaux de Chambord, Chenonceau et Amboise sont tous à moins d'une heure.", costs:{logement:660,courses:118,restos:85,nocturne:60,transport:58,sante:45,telecom:20,voyage:110} },
  { id:431, name:"Poitiers", country:"France", flag:"🇫🇷", continent:"Europe", coords:"46.5802°N, 0.3404°E", funFact:"Poitiers est l'une des villes les plus anciennes de France et abrite le Futuroscope, le premier parc d'attractions dédié aux technologies. La bataille de Poitiers en 732 a arrêté l'invasion arabe en Europe. La ville compte 3 fois plus d'étudiants que de salariés.", costs:{logement:580,courses:110,restos:78,nocturne:55,transport:52,sante:43,telecom:19,voyage:105} },
  { id:432, name:"Perpignan", country:"France", flag:"🇫🇷", continent:"Europe", coords:"42.6887°N, 2.8948°E", funFact:"Perpignan était la capitale du royaume de Majorque au XIVème siècle. Salvador Dalí a déclaré que la gare de Perpignan était le 'centre du monde'. La ville est à 20 minutes des plages méditerranéennes et 1h des pistes de ski des Pyrénées.", costs:{logement:600,courses:112,restos:80,nocturne:58,transport:54,sante:44,telecom:20,voyage:112} },
  { id:433, name:"Caen", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.1829°N, 0.3707°O", funFact:"Caen a été détruite à 75 % pendant la bataille de Normandie en 1944 et entièrement reconstruite. Son Mémorial de la Paix est l'un des musées les plus visités de France. Guillaume le Conquérant, né à 5 km de Caen, a lancé depuis ici la conquête de l'Angleterre en 1066.", costs:{logement:620,courses:112,restos:80,nocturne:56,transport:54,sante:44,telecom:20,voyage:108} },
  { id:434, name:"Clermont-Ferrand", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.7772°N, 3.0870°E", funFact:"Clermont-Ferrand est construite sur un ancien volcan et la cathédrale gothique est faite entièrement de pierre noire volcanique. C'est le siège mondial de Michelin, l'inventeur du pneu et du guide gastronomique. Blaise Pascal y est né et y a inventé la machine à calculer.", costs:{logement:600,courses:112,restos:78,nocturne:55,transport:52,sante:43,telecom:19,voyage:108} },
  { id:435, name:"Rouen", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.4431°N, 1.0993°E", funFact:"Rouen est la ville où Jeanne d'Arc a été brûlée vive en 1431. Sa cathédrale gothique a été peinte 30 fois par Monet pour capter les changements de lumière. La ville est surnommée la Ville aux Cent Clochers et son Gros-Horloge est l'une des plus belles horloges Renaissance de France.", costs:{logement:640,courses:115,restos:82,nocturne:58,transport:56,sante:45,telecom:20,voyage:108} },
  { id:436, name:"Le Havre", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.4944°N, 0.1079°E", funFact:"Le Havre a été entièrement reconstruite après la Seconde Guerre mondiale par Auguste Perret selon des principes modernistes — classé UNESCO en 2005. C'est le deuxième port de France et la ville natale de Claude Monet, qui a peint sa série des 'Impressions, Soleil Levant' depuis ce port.", costs:{logement:600,courses:110,restos:78,nocturne:55,transport:52,sante:43,telecom:19,voyage:105} },
  { id:437, name:"Metz", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.1193°N, 6.1727°E", funFact:"Metz abrite le Centre Pompidou-Metz, la première antenne décentralisée du Centre Pompidou de Paris. La cathédrale Saint-Étienne possède les plus grandes verrières du monde (6 500 m²) dont des vitraux de Marc Chagall. La ville est à 50 minutes de Luxembourg et à 1h de Strasbourg.", costs:{logement:640,courses:115,restos:82,nocturne:58,transport:56,sante:45,telecom:20,voyage:110} },
  { id:438, name:"Nancy", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.6921°N, 6.1844°E", funFact:"Nancy est la capitale mondiale de l'Art Nouveau — son École de Nancy (Gallé, Daum) a révolutionné le design au XIXème siècle. La place Stanislas est classée UNESCO et est régulièrement élue plus belle place de France. Le vrai cassoulet n'est pas de Nancy, mais la quiche lorraine vient de la région.", costs:{logement:620,courses:112,restos:80,nocturne:56,transport:53,sante:44,telecom:20,voyage:108} },
  { id:439, name:"Pau", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.2951°N, 0.3708°O", funFact:"Pau est la ville natale du roi Henri IV et offre le panorama le plus célèbre des Pyrénées depuis son boulevard des Pyrénées. La ville a accueilli le Tour de France des dizaines de fois. C'est aussi la première ville à avoir eu un service de bus à vapeur, en 1905.", costs:{logement:580,courses:108,restos:76,nocturne:52,transport:50,sante:42,telecom:19,voyage:108} },
  { id:440, name:"Limoges", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.8336°N, 1.2611°E", funFact:"Limoges est la capitale mondiale de la porcelaine — la porcelaine de Limoges est synonyme de luxe et de raffinement depuis le XVIIIème siècle. La ville est aussi connue pour son émail cloisonné et le jambon de Bayonne vient d'une ville distante de 200km.", costs:{logement:560,courses:105,restos:74,nocturne:50,transport:48,sante:41,telecom:19,voyage:105} },
  { id:441, name:"Amiens", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.8941°N, 2.2958°E", funFact:"Amiens possède la plus grande cathédrale gothique de France — Notre-Dame d'Amiens est classée UNESCO. Jules Verne y a vécu 18 ans et y a écrit Vingt Mille Lieues sous les mers. Les hortillonnages d'Amiens sont des jardins flottants de 300 hectares cultivés depuis le Moyen Âge.", costs:{logement:580,courses:108,restos:76,nocturne:52,transport:50,sante:42,telecom:19,voyage:105} },
  { id:442, name:"Valence (Drôme)", country:"France", flag:"🇫🇷", continent:"Europe", coords:"44.9334°N, 4.8924°E", funFact:"Valence dans la Drôme est le berceau de la gastronomie française moderne — c'est la ville d'Anne-Sophie Pic, 3 étoiles Michelin et seule femme chef triplement étoilée en France. La ville est à la croisée des Alpes et de la Provence et bénéficie d'un ensoleillement remarquable.", costs:{logement:620,courses:112,restos:82,nocturne:56,transport:52,sante:44,telecom:20,voyage:108} },
  { id:443, name:"Dunkerque", country:"France", flag:"🇫🇷", continent:"Europe", coords:"51.0383°N, 2.3775°E", funFact:"Dunkerque est célèbre pour l'évacuation miraculeuse de 338 000 soldats alliés en 1940 — le film de Christopher Nolan en 2017 l'a remise sur la carte mondiale. La ville est le premier port de plaisance du Nord de la France et organise le carnaval le plus important de France après Nice.", costs:{logement:540,courses:102,restos:72,nocturne:48,transport:46,sante:40,telecom:19,voyage:102} },
  { id:444, name:"Besançon", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.2380°N, 6.0243°E", funFact:"Besançon est la capitale française de l'horlogerie — elle fabriquait 60 % des montres françaises au XIXème siècle. Victor Hugo et les frères Lumière y sont nés. La citadelle de Vauban est classée UNESCO et surplombe un méandre de la rivière Doubs qui dessine presque un cercle parfait.", costs:{logement:620,courses:112,restos:80,nocturne:56,transport:52,sante:44,telecom:20,voyage:108} },
  { id:445, name:"Orléans", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.9029°N, 1.9092°E", funFact:"Orléans est à jamais associée à Jeanne d'Arc qui libéra la ville du siège anglais en 1429 — chaque année le 8 mai, la ville fête le souvenir de la Pucelle avec un défilé historique. La ville est à 1h de Paris et au cœur du Val de Loire classé UNESCO.", costs:{logement:620,courses:112,restos:80,nocturne:55,transport:53,sante:44,telecom:20,voyage:108} },
  { id:446, name:"Nîmes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.8367°N, 4.3601°E", funFact:"Nîmes possède les monuments romains les mieux conservés du monde hors d'Italie — les Arènes (2 000 ans), la Maison Carrée et le Pont du Gard à 20 km. La ville a donné son nom au tissu denim — 'De Nîmes' — qui a servi à fabriquer les premiers jeans Levi's.", costs:{logement:640,courses:115,restos:84,nocturne:60,transport:54,sante:45,telecom:20,voyage:110} },
  { id:447, name:"Montauban", country:"France", flag:"🇫🇷", continent:"Europe", coords:"44.0172°N, 1.3536°E", funFact:"Montauban est la ville natale d'Ingres, le grand peintre néoclassique, et possède un musée dédié à son œuvre. La ville est la capitale du département du Tarn-et-Garonne et est construite en briques roses, tout comme Toulouse.", costs:{logement:560,courses:105,restos:74,nocturne:50,transport:48,sante:41,telecom:19,voyage:105} },
  { id:448, name:"Bayonne", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.4926°N, 1.4740°O", funFact:"Bayonne est la capitale du Pays Basque français et a donné son nom à la baïonnette — inventée ici au XVIIème siècle. Le jambon de Bayonne est une AOP et le chocolat français a été introduit en France par les Juifs séfarades expulsés d'Espagne qui se sont installés à Bayonne au XVIème siècle.", costs:{logement:680,courses:118,restos:88,nocturne:62,transport:56,sante:46,telecom:20,voyage:112} },
  { id:449, name:"Ajaccio", country:"France", flag:"🇫🇷", continent:"Europe", coords:"41.9192°N, 8.7386°E", funFact:"Ajaccio est la capitale de la Corse et la ville natale de Napoléon Bonaparte — la maison de son enfance est un musée national. La Corse est surnommée l'Île de Beauté avec 200 km de plages de sable blanc, des montagnes à 2 700 m et le maquis méditerranéen le plus parfumé du monde.", costs:{logement:750,courses:128,restos:95,nocturne:65,transport:55,sante:47,telecom:21,voyage:130} },
  { id:450, name:"Versailles", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.8014°N, 2.1301°E", funFact:"Versailles abrite le château le plus visité du monde avec 9 millions de touristes par an. Louis XIV a déplacé toute la cour royale de Paris à Versailles en 1682 — 20 000 personnes vivaient dans le palace. Les jardins à la française couvrent 800 hectares avec 200 000 arbres plantés.", costs:{logement:920,courses:140,restos:108,nocturne:72,transport:78,sante:52,telecom:22,voyage:115} },
  ...
  { id:451, name:"Cergy", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.0359°N, 2.0711°E", funFact:"Cergy est une ville nouvelle créée de toutes pièces en 1969. Elle abrite l'une des plus grandes universités d'Île-de-France et la célèbre Axe majeur, une perspective architecturale de 3 km imaginée par Dani Karavan.", costs:{logement:750,courses:130,restos:110,nocturne:70,transport:80,sante:50,telecom:22,voyage:120} },
  { id:452, name:"Nice", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.7102°N, 7.2620°E", funFact:"Nice est la seule grande ville française à avoir appartenu au royaume de Sardaigne jusqu'en 1860. Sa Promenade des Anglais doit son nom aux touristes anglais du 19ème siècle qui la finançaient.", costs:{logement:950,courses:145,restos:130,nocturne:90,transport:55,sante:55,telecom:22,voyage:160} },
  { id:453, name:"Lyon", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.7640°N, 4.8357°E", funFact:"Lyon est la capitale mondiale de la gastronomie. Paul Bocuse y a régné pendant 50 ans et ses bouchons lyonnais sont des restaurants typiques uniques au monde.", costs:{logement:850,courses:138,restos:125,nocturne:85,transport:60,sante:52,telecom:22,voyage:140} },
  { id:454, name:"Bordeaux", country:"France", flag:"🇫🇷", continent:"Europe", coords:"44.8378°N, 0.5792°O", funFact:"Bordeaux possède le plus grand ensemble architectural du 18ème siècle en Europe classé UNESCO. La région produit 700 millions de bouteilles de vin par an.", costs:{logement:800,courses:132,restos:118,nocturne:80,transport:50,sante:50,telecom:22,voyage:150} },
  { id:455, name:"Marseille", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.2965°N, 5.3698°E", funFact:"Marseille est la plus ancienne ville de France — fondée par les Grecs en 600 avant J.-C. sous le nom de Massalia. La bouillabaisse est à l'origine un repas de pêcheurs pauvres.", costs:{logement:750,courses:128,restos:112,nocturne:80,transport:50,sante:48,telecom:22,voyage:155} },
  { id:456, name:"Toulouse", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6047°N, 1.4442°E", funFact:"Toulouse est la capitale mondiale de l'aéronautique — Airbus y assemble ses avions. La ville doit sa couleur rose à la brique locale, d'où son surnom la Ville Rose.", costs:{logement:780,courses:130,restos:115,nocturne:80,transport:52,sante:50,telecom:22,voyage:145} },
  { id:457, name:"Strasbourg", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.5734°N, 7.7521°E", funFact:"Strasbourg est l'unique ville française à avoir été capitale d'un autre pays. Elle est aussi le siège du Parlement Européen et du Conseil de l'Europe.", costs:{logement:820,courses:135,restos:118,nocturne:75,transport:55,sante:50,telecom:22,voyage:140} },
  { id:458, name:"Montpellier", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6108°N, 3.8767°E", funFact:"Montpellier a la plus jeune population de France — 25% de ses habitants sont étudiants. Sa faculté de médecine est la plus ancienne d'Europe encore en activité, fondée en 1220.", costs:{logement:780,courses:128,restos:112,nocturne:80,transport:50,sante:48,telecom:22,voyage:150} },
  { id:459, name:"Nantes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.2184°N, 1.5536°O", funFact:"Nantes est classée meilleure ville de France pour la qualité de vie. Elle a inventé les Machines de l'île, des automates géants inspirés de Jules Verne dont un éléphant de 12 mètres.", costs:{logement:800,courses:130,restos:115,nocturne:78,transport:52,sante:50,telecom:22,voyage:145} },
  { id:460, name:"Rennes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.1173°N, 1.6778°O", funFact:"Rennes est la capitale de la Bretagne dont la culture celtique reste très vivante. La ville a le métro le plus automatisé d'Europe pour sa taille.", costs:{logement:750,courses:125,restos:108,nocturne:72,transport:48,sante:48,telecom:22,voyage:140} },
  { id:461, name:"Naples", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"40.8518°N, 14.2681°E", funFact:"Naples a inventé la pizza ! La pizza margherita a été créée en 1889 pour la reine Margherite de Savoie. L'art du pizzaïolo napolitain est classé au patrimoine immatériel de l'UNESCO.", costs:{logement:600,courses:108,restos:90,nocturne:65,transport:30,sante:38,telecom:18,voyage:140} },
  { id:462, name:"Turin", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"45.0703°N, 7.6869°E", funFact:"Turin a été la première capitale de l'Italie unifiée en 1861. La ville est le berceau de l'industrie automobile italienne avec Fiat.", costs:{logement:650,courses:115,restos:98,nocturne:70,transport:32,sante:40,telecom:18,voyage:145} },
  { id:463, name:"Florence", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"43.7696°N, 11.2558°E", funFact:"Florence possède plus d'oeuvres d'art par km2 que n'importe quelle autre ville. La famille Médicis a financé Michel-Ange, Léonard de Vinci et Botticelli — Florence a inventé la Renaissance.", costs:{logement:900,courses:138,restos:125,nocturne:80,transport:35,sante:48,telecom:20,voyage:160} },
  { id:464, name:"Vérone", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"45.4384°N, 10.9916°E", funFact:"Vérone est la ville de Roméo et Juliette. Des milliers de touristes laissent cadenas et billets doux sous le balcon de Juliette. La ville possède aussi une arène romaine du 1er siècle parfaitement conservée.", costs:{logement:650,courses:112,restos:95,nocturne:65,transport:28,sante:40,telecom:18,voyage:140} },
  { id:465, name:"Palerme", country:"Italie", flag:"🇮🇹", continent:"Europe", coords:"38.1157°N, 13.3615°E", funFact:"Palerme a été la capitale du Royaume de Sicile et l'une des plus grandes villes médiévales d'Europe. Son marché du Ballarò, vieux de 1000 ans, est l'un des plus authentiques d'Europe.", costs:{logement:500,courses:95,restos:78,nocturne:55,transport:22,sante:32,telecom:16,voyage:130} },
  { id:466, name:"Edimbourg", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"55.9533°N, 3.1883°O", funFact:"Edimbourg possède la plus forte concentration de pubs par habitant au Royaume-Uni. Son festival annuel est le plus grand festival des arts du spectacle au monde avec 3 000 spectacles en août.", costs:{logement:1050,courses:148,restos:138,nocturne:100,transport:80,sante:55,telecom:28,voyage:160} },
  { id:467, name:"Manchester", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"53.4808°N, 2.2426°O", funFact:"Manchester est la première ville industrielle au monde — la révolution industrielle y est née en 1760. Elle a produit des groupes légendaires : Oasis, The Smiths, Joy Division.", costs:{logement:1000,courses:145,restos:132,nocturne:95,transport:75,sante:52,telecom:27,voyage:155} },
  { id:468, name:"Birmingham", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"52.4862°N, 1.8904°O", funFact:"Birmingham a plus de kilomètres de canaux que Venise ! La ville est le berceau du heavy metal avec Black Sabbath et Ozzy Osbourne.", costs:{logement:900,courses:140,restos:125,nocturne:90,transport:70,sante:50,telecom:26,voyage:150} },
  { id:469, name:"Glasgow", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"55.8642°N, 4.2518°O", funFact:"Glasgow est la ville la plus drôle du Royaume-Uni selon les études. C'est aussi la capitale mondiale du design et de l'art nouveau écossais.", costs:{logement:900,courses:138,restos:122,nocturne:88,transport:68,sante:50,telecom:26,voyage:150} },
  { id:470, name:"Dublin", country:"Irlande", flag:"🇮🇪", continent:"Europe", coords:"53.3498°N, 6.2603°O", funFact:"Dublin est la ville la plus jeune d'Europe en termes de population. La Guinness est brassée ici depuis 1759 avec un bail de 9 000 ans sur la brasserie Saint James's Gate.", costs:{logement:1300,courses:168,restos:158,nocturne:120,transport:100,sante:60,telecom:35,voyage:170} },
  { id:471, name:"Copenhague", country:"Danemark", flag:"🇩🇰", continent:"Europe", coords:"55.6761°N, 12.5683°E", funFact:"Copenhague est la ville la plus cycliste au monde — 62% des habitants s'y déplacent à vélo. La petite Sirène mesure seulement 1,25 mètre et est souvent qualifiée de plus grande déception touristique d'Europe.", costs:{logement:1200,courses:182,restos:178,nocturne:140,transport:110,sante:62,telecom:30,voyage:200} },
  { id:472, name:"Oslo", country:"Norvège", flag:"🇳🇴", continent:"Europe", coords:"59.9139°N, 10.7522°E", funFact:"Oslo est la ville la plus chère au monde pour sortir — une bière dépasse 10 euros. Mais la Norvège a le fonds souverain le plus riche du monde avec 1 400 milliards de dollars.", costs:{logement:1400,courses:210,restos:205,nocturne:165,transport:120,sante:70,telecom:35,voyage:220} },
  { id:473, name:"Helsinki", country:"Finlande", flag:"🇫🇮", continent:"Europe", coords:"60.1699°N, 24.9384°E", funFact:"Les Finlandais consomment le plus de café par habitant au monde — 12 kg par an ! Helsinki a aussi donné naissance à Linux, WhatsApp et Nokia.", costs:{logement:1100,courses:168,restos:162,nocturne:128,transport:100,sante:58,telecom:28,voyage:195} },
  { id:474, name:"Göteborg", country:"Suède", flag:"🇸🇪", continent:"Europe", coords:"57.7089°N, 11.9746°E", funFact:"Göteborg est la capitale scandinave de l'automobile — Volvo y est né. La ville est connue pour ses canaux, son archipel et le festival de musique Way Out West.", costs:{logement:1000,courses:158,restos:152,nocturne:118,transport:95,sante:55,telecom:27,voyage:185} },
  { id:475, name:"Genève", country:"Suisse", flag:"🇨🇭", continent:"Europe", coords:"46.2044°N, 6.1432°E", funFact:"Genève héberge plus d'organisations internationales que toute autre ville — ONU, Croix-Rouge, OMS. Le CERN y est installé, où le World Wide Web a été inventé en 1989.", costs:{logement:1900,courses:255,restos:240,nocturne:180,transport:135,sante:95,telecom:45,voyage:260} },
  { id:476, name:"Bruges", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"51.2093°N, 3.2247°E", funFact:"Bruges est si bien conservée qu'elle est surnommée la Belle Endormie. Ses canaux médiévaux lui ont valu le titre de Venise du Nord. La ville a inventé la Bourse des valeurs au 14ème siècle.", costs:{logement:850,courses:135,restos:122,nocturne:82,transport:40,sante:48,telecom:22,voyage:145} },
  { id:477, name:"Gand", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"51.0543°N, 3.7174°E", funFact:"Gand est la plus grande ville médiévale des Pays-Bas historiques jamais détruite. Son festival annuel de 10 jours est l'un des plus grands festivals de musique gratuits d'Europe.", costs:{logement:820,courses:130,restos:118,nocturne:80,transport:38,sante:46,telecom:21,voyage:140} },
  { id:478, name:"Anvers", country:"Belgique", flag:"🇧🇪", continent:"Europe", coords:"51.2194°N, 4.4025°E", funFact:"Anvers contrôle 80% du commerce mondial du diamant brut. Rubens y est né et son oeuvre est omniprésente dans la ville.", costs:{logement:850,courses:132,restos:120,nocturne:82,transport:40,sante:46,telecom:21,voyage:142} },
  { id:479, name:"Luxembourg", country:"Luxembourg", flag:"🇱🇺", continent:"Europe", coords:"49.6116°N, 6.1319°E", funFact:"Luxembourg est la seule ville classée deux fois UNESCO pour ses remparts. C'est aussi la ville avec le plus haut PIB par habitant de l'UE.", costs:{logement:1400,courses:190,restos:180,nocturne:135,transport:0,sante:70,telecom:35,voyage:180} },
  { id:480, name:"Wroclaw", country:"Pologne", flag:"🇵🇱", continent:"Europe", coords:"51.1079°N, 17.0385°E", funFact:"Wroclaw est construite sur 12 îles reliées par 112 ponts. La ville a appartenu successivement à la Bohème, l'Autriche, la Prusse et l'Allemagne avant de devenir polonaise en 1945.", costs:{logement:520,courses:90,restos:68,nocturne:52,transport:22,sante:28,telecom:12,voyage:118} },
  { id:481, name:"Gdansk", country:"Pologne", flag:"🇵🇱", continent:"Europe", coords:"54.3520°N, 18.6466°E", funFact:"Gdansk est le berceau du mouvement Solidarité qui a mis fin au communisme en Europe de l'Est. Les chantiers navals ont vu naître le syndicat de Lech Walesa en 1980.", costs:{logement:500,courses:88,restos:65,nocturne:50,transport:20,sante:27,telecom:12,voyage:115} },
  { id:482, name:"Zagreb", country:"Croatie", flag:"🇭🇷", continent:"Europe", coords:"45.8150°N, 15.9819°E", funFact:"Zagreb possède le musée des Relations Rompues — un musée dédié aux objets laissés par d'anciens amants. La cravate a été inventée par les soldats croates au 17ème siècle.", costs:{logement:650,courses:100,restos:75,nocturne:58,transport:28,sante:32,telecom:14,voyage:128} },
  { id:483, name:"Split", country:"Croatie", flag:"🇭🇷", continent:"Europe", coords:"43.5081°N, 16.4402°E", funFact:"Split est une ville construite à l'intérieur d'un palais romain ! Le Palais de Dioclétien construit en 305 après J.-C. abrite encore 3 000 habitants.", costs:{logement:700,courses:105,restos:80,nocturne:62,transport:25,sante:32,telecom:14,voyage:130} },
  { id:484, name:"Sarajevo", country:"Bosnie-Herzégovine", flag:"🇧🇦", continent:"Europe", coords:"43.8486°N, 18.3564°E", funFact:"Sarajevo a accueilli les JO d'hiver en 1984 et survécu au plus long siège d'une capitale de l'histoire moderne. La ville est surnommée la Jérusalem d'Europe pour sa coexistence de religions.", costs:{logement:400,courses:75,restos:52,nocturne:42,transport:15,sante:22,telecom:10,voyage:110} },
  { id:485, name:"Belgrade", country:"Serbie", flag:"🇷🇸", continent:"Europe", coords:"44.7866°N, 20.4489°E", funFact:"Belgrade a été détruite et reconstruite 44 fois. La ville est réputée pour sa vie nocturne parmi les meilleures d'Europe — les clubs flottants sur la Save sont légendaires.", costs:{logement:420,courses:78,restos:55,nocturne:45,transport:15,sante:22,telecom:10,voyage:112} },
  { id:486, name:"Sofia", country:"Bulgarie", flag:"🇧🇬", continent:"Europe", coords:"42.6977°N, 23.3219°E", funFact:"Sofia est l'une des plus anciennes capitales d'Europe peuplée depuis 7 000 ans. Les Bulgares font non de la tête pour dire oui et inversement — ce qui perturbe tous les visiteurs.", costs:{logement:380,courses:70,restos:48,nocturne:38,transport:12,sante:20,telecom:9,voyage:105} },
  { id:487, name:"Tbilissi", country:"Géorgie", flag:"🇬🇪", continent:"Europe", coords:"41.7151°N, 44.8271°E", funFact:"Tbilissi est la ville du monde avec le plus de caves à vin par habitant. La Géorgie est le berceau du vin — les premières jarres de fermentation datent de 8 000 ans.", costs:{logement:350,courses:65,restos:45,nocturne:38,transport:10,sante:18,telecom:8,voyage:120} },
  { id:488, name:"Erevan", country:"Arménie", flag:"🇦🇲", continent:"Europe", coords:"40.1872°N, 44.5152°E", funFact:"Erevan est l'une des plus anciennes capitales du monde — fondée en 782 avant J.-C. Le Mont Ararat, symbole national, est visible de partout mais se trouve paradoxalement en Turquie.", costs:{logement:320,courses:62,restos:42,nocturne:35,transport:10,sante:18,telecom:8,voyage:115} },
  { id:489, name:"Tirana", country:"Albanie", flag:"🇦🇱", continent:"Europe", coords:"41.3275°N, 19.8187°E", funFact:"Tirana est la seule capitale européenne sans métro ni tramway. Les 750 000 bunkers de béton construits par Hoxha couvrent encore tout le pays — un par habitant.", costs:{logement:300,courses:58,restos:40,nocturne:32,transport:10,sante:16,telecom:7,voyage:100} },
  { id:490, name:"Skopje", country:"Macédoine du Nord", flag:"🇲🇰", continent:"Europe", coords:"41.9981°N, 21.4254°E", funFact:"Skopje est la ville natale de Mère Teresa. Elle a été entièrement reconstruite après un séisme en 1963 dans un style baroque controversé avec 500 statues colossales.", costs:{logement:280,courses:55,restos:38,nocturne:30,transport:8,sante:15,telecom:7,voyage:95} },
  { id:491, name:"Podgorica", country:"Monténégro", flag:"🇲🇪", continent:"Europe", coords:"42.4304°N, 19.2594°E", funFact:"Le Monténégro signifie Montagne Noire — le pays est couvert à 70% de montagnes. Sa côte adriatique est l'une des moins touristiques d'Europe, un joyau préservé.", costs:{logement:400,courses:72,restos:50,nocturne:40,transport:12,sante:20,telecom:9,voyage:105} },
  { id:492, name:"Prishtina", country:"Kosovo", flag:"🇽🇰", continent:"Europe", coords:"42.6629°N, 21.1655°E", funFact:"Prishtina est la capitale la plus jeune d'Europe — le Kosovo a déclaré son indépendance en 2008. La ville possède une statue de Bill Clinton qui l'a aidé lors de la guerre.", costs:{logement:280,courses:52,restos:36,nocturne:28,transport:7,sante:14,telecom:6,voyage:90} },
  { id:493, name:"Minsk", country:"Biélorussie", flag:"🇧🇾", continent:"Europe", coords:"53.9045°N, 27.5615°E", funFact:"Minsk a été entièrement reconstruite par Staline après la Seconde Guerre mondiale dans un style néoclassique soviétique monumental — la ville la mieux conservée de cette architecture.", costs:{logement:300,courses:55,restos:38,nocturne:30,transport:8,sante:15,telecom:6,voyage:95} },
  { id:494, name:"Chengdu", country:"Chine", flag:"🇨🇳", continent:"Asie", coords:"30.5728°N, 104.0668°E", funFact:"Chengdu est la capitale mondiale du panda géant avec plus de 100 pandas au centre de recherche. La ville compte plus de restaurants par km2 que Manhattan.", costs:{logement:450,courses:88,restos:65,nocturne:55,transport:28,sante:35,telecom:15,voyage:200} },
  { id:495, name:"Xi'an", country:"Chine", flag:"🇨🇳", continent:"Asie", coords:"34.3416°N, 108.9398°E", funFact:"L'Armée de Terre Cuite de Qin Shi Huang avec 8 000 soldats grandeur nature a été découverte en 1974 par un paysan qui creusait un puits. Xi'an était la plus grande ville du monde au 7ème siècle.", costs:{logement:380,courses:80,restos:58,nocturne:45,transport:22,sante:28,telecom:12,voyage:180} },
  { id:496, name:"Hangzhou", country:"Chine", flag:"🇨🇳", continent:"Asie", coords:"30.2741°N, 120.1551°E", funFact:"Hangzhou est le siège d'Alibaba. Marco Polo la décrivait comme la plus belle cité du monde. Son lac de l'Ouest est inscrit au patrimoine mondial de l'UNESCO.", costs:{logement:500,courses:95,restos:70,nocturne:60,transport:30,sante:38,telecom:16,voyage:210} },
  { id:497, name:"Osaka", country:"Japon", flag:"🇯🇵", continent:"Asie", coords:"34.6937°N, 135.5023°E", funFact:"Osaka est la capitale gastronomique du Japon — les habitants dépensent plus en nourriture que partout ailleurs dans le pays. Le takoyaki et l'okonomiyaki y ont été inventés.", costs:{logement:850,courses:148,restos:142,nocturne:100,transport:85,sante:52,telecom:32,voyage:250} },
  { id:498, name:"Kyoto", country:"Japon", flag:"🇯🇵", continent:"Asie", coords:"35.0116°N, 135.7681°E", funFact:"Kyoto a été la capitale impériale du Japon pendant 1 000 ans. Elle possède 17 sites classés UNESCO. Elle a été retirée de la liste des cibles atomiques en 1945 grâce à son importance culturelle.", costs:{logement:900,courses:152,restos:145,nocturne:90,transport:80,sante:52,telecom:32,voyage:240} },
  { id:499, name:"Fukuoka", country:"Japon", flag:"🇯🇵", continent:"Asie", coords:"33.5904°N, 130.4017°E", funFact:"Fukuoka est la ville japonaise la plus proche du continent asiatique. Ses yatai — 150 petits stands de ramen sous des bâches bleues — sont uniques au Japon.", costs:{logement:700,courses:132,restos:125,nocturne:85,transport:70,sante:48,telecom:30,voyage:220} },
  { id:500, name:"Ho Chi Minh Ville", country:"Vietnam", flag:"🇻🇳", continent:"Asie", coords:"10.8231°N, 106.6297°E", funFact:"Ho Chi Minh Ville a 9 millions d'habitants et 45 millions de motos — soit 5 motos par habitant. La croissance économique du Vietnam est l'une des plus rapides d'Asie.", costs:{logement:380,courses:72,restos:48,nocturne:42,transport:15,sante:25,telecom:10,voyage:180} },
  { id:501, name:"Hanoi", country:"Vietnam", flag:"🇻🇳", continent:"Asie", coords:"21.0245°N, 105.8412°E", funFact:"Hanoi a plus de 1 000 ans d'histoire. Son lac Hoan Kiem abrite une tortue géante sacrée selon la légende. Les rues du Vieux Quartier portent encore les noms des corporations médiévales.", costs:{logement:350,courses:68,restos:45,nocturne:38,transport:12,sante:22,telecom:9,voyage:175} },
  { id:502, name:"Kuala Lumpur", country:"Malaisie", flag:"🇲🇾", continent:"Asie", coords:"3.1390°N, 101.6869°E", funFact:"Les Tours Petronas ont été les plus hautes du monde de 1998 à 2004. KL est un melting-pot unique de cultures malaise, chinoise et indienne.", costs:{logement:550,courses:100,restos:72,nocturne:58,transport:28,sante:42,telecom:15,voyage:200} },
  { id:503, name:"Manille", country:"Philippines", flag:"🇵🇭", continent:"Asie", coords:"14.5995°N, 120.9842°E", funFact:"Manille est la ville la plus dense au monde avec 71 000 habitants par km2. Le jeepney, minibus décoré issu des jeeps américaines de 1945, est le symbole national.", costs:{logement:380,courses:72,restos:48,nocturne:42,transport:12,sante:25,telecom:10,voyage:160} },
  { id:504, name:"Colombo", country:"Sri Lanka", flag:"🇱🇰", continent:"Asie", coords:"6.9271°N, 79.8612°E", funFact:"Le Sri Lanka est la première démocratie au monde à avoir élu une femme Premier ministre en 1960. L'île produit le tiers du thé mondial.", costs:{logement:280,courses:58,restos:38,nocturne:30,transport:10,sante:18,telecom:7,voyage:140} },
  { id:505, name:"Katmandou", country:"Népal", flag:"🇳🇵", continent:"Asie", coords:"27.7172°N, 85.3240°E", funFact:"Katmandou est le point de départ de toutes les expéditions vers l'Everest. La ville abrite 7 sites UNESCO dans un rayon de 15 km.", costs:{logement:220,courses:48,restos:30,nocturne:22,transport:8,sante:14,telecom:6,voyage:130} },
  { id:506, name:"Ulaanbaatar", country:"Mongolie", flag:"🇲🇳", continent:"Asie", coords:"47.8864°N, 106.9057°E", funFact:"Ulaanbaatar est la capitale la plus froide du monde avec une moyenne annuelle de -2 degrés. Le tiers de la population mongole vit dans des yourtes traditionnelles en plein centre.", costs:{logement:280,courses:55,restos:38,nocturne:28,transport:10,sante:15,telecom:7,voyage:150} },
  { id:507, name:"Accra", country:"Ghana", flag:"🇬🇭", continent:"Afrique", coords:"5.6037°N, 0.1870°O", funFact:"Accra est la ville la plus dynamique d'Afrique de l'Ouest. Le Ghana a été le premier pays africain indépendant en 1957. Les cercueils fantaisie en forme d'avion ou de poisson sont une tradition funéraire locale unique.", costs:{logement:350,courses:68,restos:45,nocturne:38,transport:12,sante:22,telecom:9,voyage:160} },
  { id:508, name:"Abidjan", country:"Côte d'Ivoire", flag:"🇨🇮", continent:"Afrique", coords:"5.3600°N, 4.0083°O", funFact:"Abidjan est la capitale économique de l'Afrique francophone avec le plus grand port d'Afrique de l'Ouest. Elle est surnommée le Paris de l'Afrique de l'Ouest.", costs:{logement:400,courses:75,restos:50,nocturne:42,transport:14,sante:25,telecom:10,voyage:170} },
  { id:509, name:"Dakar", country:"Sénégal", flag:"🇸🇳", continent:"Afrique", coords:"14.7167°N, 17.4677°O", funFact:"Dakar est le point le plus occidental de l'Afrique continentale. La teranga — l'hospitalité sénégalaise — est légendaire et le pays est l'un des plus stables d'Afrique.", costs:{logement:320,courses:62,restos:42,nocturne:35,transport:10,sante:20,telecom:8,voyage:150} },
  { id:510, name:"Casablanca", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"33.5731°N, 7.5898°O", funFact:"La Mosquée Hassan II de Casablanca est la troisième plus grande au monde avec un minaret de 210 mètres. Le film Casablanca de 1942 n'y a jamais été tourné.", costs:{logement:380,courses:70,restos:48,nocturne:40,transport:12,sante:22,telecom:8,voyage:140} },
  { id:511, name:"Marrakech", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"31.6295°N, 7.9811°O", funFact:"Marrakech est surnommée la Ville Rouge. La place Jemaa el-Fna est le seul marché classé patrimoine immatériel de l'UNESCO dans le monde.", costs:{logement:320,courses:60,restos:42,nocturne:35,transport:10,sante:18,telecom:7,voyage:135} },
  { id:512, name:"Tunis", country:"Tunisie", flag:"🇹🇳", continent:"Afrique", coords:"36.8065°N, 10.1815°E", funFact:"Tunis est à quelques kilomètres de Carthage, l'empire qui faillit vaincre Rome. La Tunisie est le premier pays arabe à avoir adopté un code de la famille égalitaire en 1956.", costs:{logement:280,courses:55,restos:38,nocturne:30,transport:8,sante:15,telecom:7,voyage:120} },
  { id:513, name:"Addis-Abeba", country:"Ethiopie", flag:"🇪🇹", continent:"Afrique", coords:"9.0320°N, 38.7469°E", funFact:"Addis-Abeba est le siège de l'Union Africaine. L'Ethiopie est le seul pays africain à n'avoir jamais été colonisé. Le café arabica y a été découvert au 9ème siècle.", costs:{logement:250,courses:50,restos:32,nocturne:25,transport:8,sante:14,telecom:6,voyage:140} },
  { id:514, name:"Kigali", country:"Rwanda", flag:"🇷🇼", continent:"Afrique", coords:"1.9441°S, 30.0619°E", funFact:"Kigali est la ville la plus propre d'Afrique. Le Rwanda interdit les sacs plastiques et a le taux de femmes parlementaires le plus élevé du monde à 61%.", costs:{logement:300,courses:58,restos:38,nocturne:32,transport:10,sante:18,telecom:7,voyage:150} },
  { id:515, name:"Vancouver", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"49.2827°N, 123.1207°O", funFact:"Vancouver est la ville la plus chère du Canada mais aussi dans le top 3 mondial de la qualité de vie. Ski, surf et forêt tropicale à 1h du centre-ville — unique au monde.", costs:{logement:1400,courses:188,restos:172,nocturne:125,transport:110,sante:80,telecom:50,voyage:280} },
  { id:516, name:"Toronto", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"43.6532°N, 79.3832°O", funFact:"Toronto est la ville la plus multiculturelle du monde — plus de 200 langues y sont parlées. Elle est la 4ème plus grande ville d'Amérique du Nord.", costs:{logement:1500,courses:195,restos:178,nocturne:130,transport:115,sante:82,telecom:52,voyage:250} },
  { id:517, name:"Los Angeles", country:"Etats-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"34.0522°N, 118.2437°O", funFact:"Los Angeles est la capitale mondiale du cinéma. La ville est si étalée qu'il faut 2h pour la traverser. La moitié des acteurs de LA sont serveurs ou chauffeurs Uber.", costs:{logement:1800,courses:200,restos:195,nocturne:155,transport:100,sante:120,telecom:52,voyage:260} },
  { id:518, name:"Chicago", country:"Etats-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"41.8781°N, 87.6298°O", funFact:"Chicago a inventé le gratte-ciel en 1885 et est la capitale mondiale du blues et du jazz après La Nouvelle-Orléans. Son surnom Ville des Vents est en fait un mythe.", costs:{logement:1400,courses:182,restos:178,nocturne:140,transport:105,sante:110,telecom:48,voyage:240} },
  { id:519, name:"Miami", country:"Etats-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"25.7617°N, 80.1918°O", funFact:"Miami est la seule grande ville américaine fondée par une femme en 1896. South Beach possède le plus grand quartier Art Déco du monde.", costs:{logement:1600,courses:190,restos:185,nocturne:150,transport:90,sante:115,telecom:50,voyage:255} },
  { id:520, name:"La Havane", country:"Cuba", flag:"🇨🇺", continent:"Amérique du Nord", coords:"23.1136°N, 82.3666°O", funFact:"La Havane est une ville hors du temps avec ses voitures américaines des années 50. Son Malecon, promenade de 8 km le long de la mer, est le salon de la ville.", costs:{logement:250,courses:48,restos:32,nocturne:25,transport:8,sante:12,telecom:5,voyage:120} },
  { id:521, name:"San José", country:"Costa Rica", flag:"🇨🇷", continent:"Amérique du Nord", coords:"9.9281°N, 84.0907°O", funFact:"Le Costa Rica a supprimé son armée en 1948 pour investir dans l'éducation. 99% de son électricité est renouvelable. La pura vida est la philosophie nationale.", costs:{logement:550,courses:105,restos:72,nocturne:58,transport:25,sante:40,telecom:18,voyage:160} },
  { id:522, name:"Medellín", country:"Colombie", flag:"🇨🇴", continent:"Amérique du Sud", coords:"6.2442°N, 75.5812°O", funFact:"Medellín a été la ville la plus dangereuse au monde en 1991 et est devenue un modèle de transformation urbaine. Son métrocâble connecte les quartiers des collines au reste de la ville.", costs:{logement:380,courses:78,restos:52,nocturne:45,transport:15,sante:28,telecom:12,voyage:150} },
  { id:523, name:"Quito", country:"Equateur", flag:"🇪🇨", continent:"Amérique du Sud", coords:"0.1807°S, 78.4678°O", funFact:"Quito est la capitale la plus haute du monde à 2 850m. Elle possède le centre historique colonial le mieux préservé d'Amérique Latine, premier site UNESCO en 1978.", costs:{logement:350,courses:72,restos:48,nocturne:38,transport:12,sante:22,telecom:10,voyage:155} },
  { id:524, name:"La Paz", country:"Bolivie", flag:"🇧🇴", continent:"Amérique du Sud", coords:"16.5000°S, 68.1500°O", funFact:"La Paz est la capitale gouvernementale la plus haute du monde à 3 650m. Son téléphérique urbain est le plus long au monde avec 30 lignes.", costs:{logement:280,courses:58,restos:38,nocturne:28,transport:8,sante:14,telecom:6,voyage:130} },
  { id:525, name:"Montevideo", country:"Uruguay", flag:"🇺🇾", continent:"Amérique du Sud", coords:"34.9011°S, 56.1645°O", funFact:"Montevideo est régulièrement classée ville avec la meilleure qualité de vie d'Amérique Latine. L'Uruguay est le pays le plus stable et le moins corrompu d'Amérique du Sud.", costs:{logement:550,courses:105,restos:72,nocturne:58,transport:28,sante:38,telecom:18,voyage:160} },
  { id:526, name:"Auckland", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"36.8485°S, 174.7633°E", funFact:"Auckland est construite sur 53 volcans endormis. La ville concentre un tiers de la population néo-zélandaise et les All Blacks de rugby en sont originaires.", costs:{logement:1350,courses:182,restos:172,nocturne:125,transport:115,sante:78,telecom:42,voyage:340} },
  { id:527, name:"Melbourne", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"37.8136°S, 144.9631°E", funFact:"Melbourne a été élue 7 fois consécutives ville la plus agréable à vivre. Elle a inventé le flat white. Ses ruelles street art sont un musée à ciel ouvert.", costs:{logement:1350,courses:180,restos:172,nocturne:125,transport:118,sante:82,telecom:40,voyage:350} },
  { id:528, name:"Brisbane", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"27.4698°S, 153.0251°E", funFact:"Brisbane accueillera les Jeux Olympiques 2032. La ville bénéficie de 283 jours de soleil par an et est la porte d'entrée pour la Grande Barrière de Corail.", costs:{logement:1150,courses:168,restos:158,nocturne:112,transport:105,sante:75,telecom:38,voyage:330} },
  { id:529, name:"Wellington", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"41.2865°S, 174.7762°E", funFact:"Wellington est la capitale la plus australe du monde. Peter Jackson y a tourné Le Seigneur des Anneaux. La ville a la plus haute concentration de cafés par habitant au monde.", costs:{logement:1150,courses:168,restos:158,nocturne:112,transport:100,sante:72,telecom:40,voyage:320} },
  { id:530, name:"Port Louis", country:"Maurice", flag:"🇲🇺", continent:"Afrique", coords:"20.1609°S, 57.4983°E", funFact:"Maurice est l'une des économies africaines les plus développées. Le dodo y est éteint depuis 1681. L'île est un modèle de développement tropical sans grands prédateurs ni maladies tropicales graves.", costs:{logement:550,courses:105,restos:72,nocturne:55,transport:25,sante:38,telecom:15,voyage:200} },
];

const CONTINENTS = ["Tous","Europe","Asie","Amérique du Nord","Amérique du Sud","Afrique","Océanie"];

const EXTRA_CITIES = [
  { id:531, name:"Cergy", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.0359°N, 2.0632°E", funFact:"Cergy est la ville nouvelle la plus emblématique de France, conçue dans les années 70 comme une ville idéale. Son axe majeur aligné sur le soleil s'étend sur 3 km. L'université CY Cergy Paris accueille plus de 20 000 étudiants dans un campus verdoyant en bord d'Oise.", costs:{logement:650,courses:130,restos:115,nocturne:80,transport:75,sante:50,telecom:22,voyage:120}, safety:62, english:3 },
  { id:532, name:"Toulouse", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6047°N, 1.4442°E", funFact:"Toulouse est surnommée la Ville Rose à cause de ses briques en terre cuite. C'est la capitale européenne de l'aéronautique — Airbus y assemble ses avions et le Concorde y a effectué son premier vol en 1969.", costs:{logement:680,courses:125,restos:110,nocturne:80,transport:60,sante:48,telecom:21,voyage:115}, safety:58, english:3 },
  { id:533, name:"Bordeaux", country:"France", flag:"🇫🇷", continent:"Europe", coords:"44.8378°N, 0.5792°O", funFact:"Bordeaux est classée au patrimoine UNESCO pour son ensemble urbain classique. La ville produit les vins les plus prestigieux du monde. Le miroir d'eau devant la Bourse est le plus grand au monde.", costs:{logement:720,courses:130,restos:115,nocturne:82,transport:62,sante:50,telecom:22,voyage:115}, safety:60, english:3 },
  { id:534, name:"Nantes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.2184°N, 1.5536°O", funFact:"Nantes est célèbre pour ses éléphants mécaniques géants des Machines de l'Ile. La ville est régulièrement élue la plus agréable à vivre de France.", costs:{logement:680,courses:122,restos:108,nocturne:78,transport:58,sante:47,telecom:21,voyage:110}, safety:62, english:3 },
  { id:535, name:"Strasbourg", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.5734°N, 7.7521°E", funFact:"Strasbourg est l'unique ville au monde à abriter deux parlements internationaux — le Parlement Européen et le Conseil de l'Europe. Son marché de Noël fondé en 1570 est le plus vieux d'Europe.", costs:{logement:700,courses:128,restos:112,nocturne:80,transport:60,sante:49,telecom:22,voyage:112}, safety:64, english:4 },
  { id:536, name:"Montpellier", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.6108°N, 3.8767°E", funFact:"Montpellier possède la plus vieille université de médecine du monde encore en activité, fondée en 1220. La ville est la métropole française dont la population augmente le plus vite depuis 50 ans.", costs:{logement:650,courses:120,restos:105,nocturne:78,transport:55,sante:46,telecom:21,voyage:112}, safety:60, english:3 },
  { id:537, name:"Lille", country:"France", flag:"🇫🇷", continent:"Europe", coords:"50.6292°N, 3.0573°E", funFact:"Lille est à 1h de Paris, 35 min de Bruxelles et 1h20 de Londres en Eurostar. Sa Braderie chaque septembre est le plus grand marché aux puces du monde.", costs:{logement:600,courses:118,restos:102,nocturne:75,transport:58,sante:46,telecom:21,voyage:105}, safety:58, english:3 },
  { id:538, name:"Nice", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.7102°N, 7.2620°E", funFact:"Nice a été italienne jusqu'en 1860. La Promenade des Anglais doit son nom aux riches Anglais qui la finançaient au 19ème siècle pour se promener au soleil.", costs:{logement:850,courses:140,restos:125,nocturne:90,transport:65,sante:52,telecom:22,voyage:130}, safety:65, english:3 },
  { id:539, name:"Rennes", country:"France", flag:"🇫🇷", continent:"Europe", coords:"48.1173°N, 1.6778°O", funFact:"Rennes est l'une des villes les plus étudiantes de France avec 70 000 étudiants pour 220 000 habitants. La ville a brûlé en 1720 et a été reconstruite avec un mélange unique d'architecture médiévale et classique.", costs:{logement:620,courses:118,restos:103,nocturne:76,transport:56,sante:46,telecom:21,voyage:108}, safety:62, english:3 },
  { id:540, name:"Grenoble", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.1885°N, 5.7245°E", funFact:"Grenoble est entourée de trois massifs alpins. En 20 minutes de téléphérique on passe du centre-ville à 1 200 mètres d'altitude. La ville est le berceau de l'industrie des semi-conducteurs en France.", costs:{logement:640,courses:120,restos:105,nocturne:76,transport:56,sante:47,telecom:21,voyage:110}, safety:60, english:3 },
  { id:541, name:"Dijon", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.3220°N, 5.0415°E", funFact:"Dijon est la capitale mondiale de la moutarde. La ville est aussi le coeur de la Bourgogne viticole, entourée de vignes classées UNESCO.", costs:{logement:580,courses:115,restos:100,nocturne:72,transport:52,sante:44,telecom:20,voyage:105}, safety:65, english:3 },
  { id:542, name:"Rouen", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.4432°N, 1.0993°E", funFact:"Jeanne d'Arc a été brûlée vive sur la place du Vieux-Marché de Rouen en 1431. La cathédrale de Rouen fut sujet de 30 tableaux de Monet.", costs:{logement:580,courses:115,restos:100,nocturne:70,transport:52,sante:44,telecom:20,voyage:100}, safety:63, english:3 },
  { id:543, name:"Metz", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.1193°N, 6.1757°E", funFact:"Metz possède la plus grande verrière gothique du monde avec 6 500 m² de vitraux dans sa cathédrale dont des oeuvres de Chagall. Elle abrite le Centre Pompidou-Metz, premier Pompidou hors Paris.", costs:{logement:540,courses:108,restos:93,nocturne:65,transport:47,sante:42,telecom:19,voyage:98}, safety:64, english:3 },
  { id:544, name:"Tours", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.3941°N, 0.6848°E", funFact:"Tours est au coeur de la vallée de la Loire classée UNESCO avec 42 châteaux royaux dans un rayon de 50 km. Les habitants parlent le français le plus pur — sans accent régional.", costs:{logement:560,courses:112,restos:97,nocturne:68,transport:50,sante:43,telecom:20,voyage:102}, safety:66, english:3 },
  { id:545, name:"Angers", country:"France", flag:"🇫🇷", continent:"Europe", coords:"47.4784°N, 0.5632°O", funFact:"Angers abrite la plus grande tapisserie médiévale du monde — l'Apocalypse d'Angers, 144 mètres réalisée entre 1373 et 1382. La ville est aussi capitale du Cointreau, inventé ici en 1875.", costs:{logement:550,courses:110,restos:95,nocturne:66,transport:48,sante:42,telecom:20,voyage:100}, safety:66, english:3 },
  { id:546, name:"Caen", country:"France", flag:"🇫🇷", continent:"Europe", coords:"49.1829°N, 0.3707°O", funFact:"Caen a été détruite à 75 % lors du Débarquement en 1944. Entièrement reconstruite, elle abrite le Mémorial pour la Paix, le plus grand musée dédié à la Seconde Guerre mondiale en France.", costs:{logement:530,courses:108,restos:93,nocturne:65,transport:46,sante:42,telecom:19,voyage:98}, safety:67, english:3 },
  { id:547, name:"Clermont-Ferrand", country:"France", flag:"🇫🇷", continent:"Europe", coords:"45.7797°N, 3.0863°E", funFact:"Clermont-Ferrand est construite sur du basalte volcanique noir. C'est ici que Michelin a été fondé en 1889. La ville est entourée de 80 volcans éteints.", costs:{logement:540,courses:112,restos:97,nocturne:68,transport:48,sante:43,telecom:20,voyage:100}, safety:65, english:3 },
  { id:548, name:"Aix-en-Provence", country:"France", flag:"🇫🇷", continent:"Europe", coords:"43.5297°N, 5.4474°E", funFact:"Aix est la ville natale de Cézanne qui a peint la montagne Sainte-Victoire plus de 80 fois. Ses 100 fontaines lui valent le surnom de ville aux mille fontaines.", costs:{logement:720,courses:132,restos:118,nocturne:82,transport:58,sante:49,telecom:22,voyage:120}, safety:67, english:3 },
  { id:549, name:"Vancouver", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"49.2827°N, 123.1207°O", funFact:"Vancouver est cerné par l'océan Pacifique et les Rocheuses enneigées. On peut skier le matin et surfer l'après-midi le même jour.", costs:{logement:1400,courses:175,restos:158,nocturne:110,transport:95,sante:70,telecom:48,voyage:260}, safety:76, english:6 },
  { id:550, name:"Calgary", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"51.0447°N, 114.0719°O", funFact:"Calgary est la ville la plus ensoleillée du Canada avec 333 jours de soleil par an. Le Stampede annuel, le plus grand rodéo du monde, attire 1,2 million de visiteurs chaque juillet.", costs:{logement:1050,courses:162,restos:142,nocturne:98,transport:88,sante:66,telecom:46,voyage:240}, safety:80, english:6 },
  { id:551, name:"Québec City", country:"Canada", flag:"🇨🇦", continent:"Amérique du Nord", coords:"46.8139°N, 71.2082°O", funFact:"Québec est la seule ville d'Amérique du Nord dont les remparts médiévaux sont encore intacts — classés UNESCO. Le Château Frontenac est l'hôtel le plus photographié au monde.", costs:{logement:820,courses:148,restos:128,nocturne:85,transport:72,sante:58,telecom:42,voyage:210}, safety:82, english:4 },
  { id:552, name:"Los Angeles", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"34.0522°N, 118.2437°O", funFact:"Los Angeles est construite sur 6 failles sismiques majeures. Hollywood produit 500 films par an et la ville compte plus de voitures que d'habitants.", costs:{logement:1700,courses:195,restos:188,nocturne:145,transport:120,sante:125,telecom:52,voyage:270}, safety:58, english:6 },
  { id:553, name:"Chicago", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"41.8781°N, 87.6298°O", funFact:"Chicago a inventé l'architecture moderne — le premier gratte-ciel du monde y a été construit en 1885. La ville a été entièrement reconstruite après le grand incendie de 1871.", costs:{logement:1300,courses:180,restos:172,nocturne:130,transport:105,sante:118,telecom:50,voyage:240}, safety:52, english:6 },
  { id:554, name:"Miami", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"25.7617°N, 80.1918°O", funFact:"Miami est la seule grande ville américaine fondée par une femme — Julia Tuttle en 1896. 65 % des habitants parlent espagnol comme première langue.", costs:{logement:1500,courses:185,restos:180,nocturne:150,transport:100,sante:120,telecom:50,voyage:230}, safety:55, english:6 },
  { id:555, name:"Seattle", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"47.6062°N, 122.3321°O", funFact:"Seattle est la capitale mondiale du café — Starbucks y a été fondé en 1971. Amazon et Boeing y ont leurs sièges sociaux.", costs:{logement:1600,courses:188,restos:180,nocturne:130,transport:115,sante:122,telecom:52,voyage:260}, safety:60, english:6 },
  { id:556, name:"Boston", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"42.3601°N, 71.0589°O", funFact:"Boston est la ville universitaire la plus dense du monde avec Harvard, MIT et 50 autres universités dans un rayon de 15 km.", costs:{logement:1600,courses:190,restos:182,nocturne:130,transport:110,sante:120,telecom:50,voyage:240}, safety:62, english:6 },
  { id:557, name:"Austin", country:"États-Unis", flag:"🇺🇸", continent:"Amérique du Nord", coords:"30.2672°N, 97.7431°O", funFact:"Austin est surnommée Live Music Capital of the World avec 250 concerts par soir. Tesla, Apple et SpaceX y ont des campus importants.", costs:{logement:1200,courses:170,restos:162,nocturne:120,transport:95,sante:110,telecom:48,voyage:220}, safety:62, english:6 },
  { id:558, name:"Medellín", country:"Colombie", flag:"🇨🇴", continent:"Amérique du Sud", coords:"6.2442°N, 75.5812°O", funFact:"Medellín a été élue ville la plus innovante du monde en 2013 — quelques années après avoir été la plus violente. Ses escalators électriques gratuits ont révolutionné l'urbanisme mondial.", costs:{logement:400,courses:85,restos:60,nocturne:52,transport:15,sante:32,telecom:12,voyage:160}, safety:45, english:2 },
  { id:559, name:"Rio de Janeiro", country:"Brésil", flag:"🇧🇷", continent:"Amérique du Sud", coords:"22.9068°S, 43.1729°O", funFact:"Rio abrite la plus grande forêt urbaine du monde — la Tijuca, 3 200 hectares au coeur de la ville. Le Christ Rédempteur a été élu une des 7 nouvelles merveilles du monde.", costs:{logement:600,courses:105,restos:75,nocturne:70,transport:25,sante:38,telecom:14,voyage:200}, safety:40, english:2 },
  { id:560, name:"São Paulo", country:"Brésil", flag:"🇧🇷", continent:"Amérique du Sud", coords:"23.5505°S, 46.6333°O", funFact:"São Paulo est la plus grande ville de l'hémisphère sud avec 22 millions d'habitants. La ville compte plus d'hélicoptères que n'importe quelle autre ville au monde.", costs:{logement:550,courses:98,restos:68,nocturne:62,transport:22,sante:36,telecom:13,voyage:195}, safety:38, english:2 },
  { id:561, name:"Montevideo", country:"Uruguay", flag:"🇺🇾", continent:"Amérique du Sud", coords:"34.9011°S, 56.1915°O", funFact:"Montevideo est régulièrement classée ville la plus sûre et la plus heureuse d'Amérique Latine.", costs:{logement:500,courses:95,restos:68,nocturne:55,transport:20,sante:35,telecom:14,voyage:210}, safety:62, english:2 },
  { id:562, name:"La Paz", country:"Bolivie", flag:"🇧🇴", continent:"Amérique du Sud", coords:"16.5000°S, 68.1500°O", funFact:"La Paz est la capitale administrative la plus haute du monde à 3 640 mètres. La ville possède le plus grand réseau de téléphériques urbains au monde avec 10 lignes.", costs:{logement:280,courses:65,restos:45,nocturne:38,transport:8,sante:22,telecom:9,voyage:180}, safety:45, english:1 },
  { id:563, name:"Guadalajara", country:"Mexique", flag:"🇲🇽", continent:"Amérique du Nord", coords:"20.6597°N, 103.3496°O", funFact:"Guadalajara est le berceau de la tequila, du mariachi et de la charrería — les trois symboles culturels les plus iconiques du Mexique.", costs:{logement:420,courses:90,restos:62,nocturne:55,transport:18,sante:28,telecom:12,voyage:145}, safety:48, english:2 },
  { id:564, name:"Casablanca", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"33.5731°N, 7.5898°O", funFact:"Casablanca abrite la Grande Mosquée Hassan II, la 3ème plus grande mosquée du monde. Le film Casablanca n'a jamais été tourné au Maroc.", costs:{logement:350,courses:72,restos:50,nocturne:45,transport:12,sante:25,telecom:9,voyage:120}, safety:55, english:2 },
  { id:565, name:"Marrakech", country:"Maroc", flag:"🇲🇦", continent:"Afrique", coords:"31.6295°N, 7.9811°O", funFact:"La médina de Marrakech fondée en 1070 est classée UNESCO. La place Djemaa el-Fna est le seul espace culturel de tradition orale classé patrimoine immatériel UNESCO.", costs:{logement:300,courses:65,restos:45,nocturne:40,transport:10,sante:22,telecom:8,voyage:115}, safety:55, english:2 },
  { id:566, name:"Tunis", country:"Tunisie", flag:"🇹🇳", continent:"Afrique", coords:"36.8065°N, 10.1815°E", funFact:"Tunis est à 20 km des ruines de Carthage, l'ancienne rivale de Rome. La médina de Tunis fondée au 7ème siècle est l'une des mieux conservées au monde.", costs:{logement:280,courses:60,restos:42,nocturne:35,transport:10,sante:20,telecom:7,voyage:110}, safety:58, english:2 },
  { id:567, name:"Abidjan", country:"Côte d'Ivoire", flag:"🇨🇮", continent:"Afrique", coords:"5.3600°N, 4.0083°O", funFact:"Abidjan est la capitale économique de l'Afrique de l'Ouest francophone et abrite le plus grand port de conteneurs d'Afrique subsaharienne.", costs:{logement:380,courses:78,restos:52,nocturne:45,transport:14,sante:28,telecom:10,voyage:180}, safety:45, english:2 },
  { id:568, name:"Kigali", country:"Rwanda", flag:"🇷🇼", continent:"Afrique", coords:"1.9403°S, 30.0618°E", funFact:"Kigali est la ville la plus propre d'Afrique — les sacs plastiques y sont interdits depuis 2008. Le Rwanda est le pays avec le plus de femmes au parlement au monde (61%).", costs:{logement:350,courses:68,restos:48,nocturne:38,transport:12,sante:22,telecom:8,voyage:180}, safety:72, english:3 },
  { id:569, name:"Mumbai", country:"Inde", flag:"🇮🇳", continent:"Asie", coords:"19.0760°N, 72.8777°E", funFact:"Mumbai est le coeur financier de l'Inde. Dharavi, le plus grand bidonville d'Asie, génère 1 milliard de dollars par an grâce à son industrie artisanale.", costs:{logement:420,courses:78,restos:52,nocturne:45,transport:15,sante:28,telecom:8,voyage:210}, safety:55, english:4 },
  { id:570, name:"Bangalore", country:"Inde", flag:"🇮🇳", continent:"Asie", coords:"12.9716°N, 77.5946°E", funFact:"Bangalore est surnommée la Silicon Valley de l'Inde avec les centres R&D de Google, Microsoft et Apple. La ville consomme plus de bière que n'importe quelle autre ville indienne.", costs:{logement:380,courses:68,restos:45,nocturne:40,transport:14,sante:24,telecom:7,voyage:195}, safety:58, english:5 },
  { id:571, name:"Katmandou", country:"Népal", flag:"🇳🇵", continent:"Asie", coords:"27.7172°N, 85.3240°E", funFact:"Katmandou est entourée de 8 des 14 sommets de plus de 8 000 mètres dont l'Everest. La vallée compte 7 sites classés UNESCO.", costs:{logement:200,courses:45,restos:30,nocturne:22,transport:6,sante:14,telecom:5,voyage:160}, safety:50, english:3 },
  { id:572, name:"Colombo", country:"Sri Lanka", flag:"🇱🇰", continent:"Asie", coords:"6.9271°N, 79.8612°E", funFact:"Colombo est le centre commercial de l'île aux épices — Sri Lanka produit 90% de la cannelle mondiale. Le thé de Ceylan est exporté vers 100 pays.", costs:{logement:280,courses:58,restos:38,nocturne:30,transport:8,sante:18,telecom:6,voyage:170}, safety:58, english:4 },
  { id:573, name:"Phnom Penh", country:"Cambodge", flag:"🇰🇭", continent:"Asie", coords:"11.5564°N, 104.9282°E", funFact:"Phnom Penh a été entièrement vidée en 1975 quand les Khmers Rouges ont forcé ses 2 millions d'habitants à partir. La ville renaît aujourd'hui.", costs:{logement:350,courses:65,restos:42,nocturne:38,transport:10,sante:22,telecom:8,voyage:175}, safety:48, english:3 },
  { id:574, name:"Tbilissi", country:"Géorgie", flag:"🇬🇪", continent:"Asie", coords:"41.6938°N, 44.8015°E", funFact:"Tbilissi est l'une des destinations les plus branchées d'Europe de l'Est. La Géorgie a inventé le vin il y a 8 000 ans.", costs:{logement:350,courses:68,restos:48,nocturne:42,transport:10,sante:22,telecom:8,voyage:155}, safety:68, english:3 },
  { id:575, name:"Amman", country:"Jordanie", flag:"🇯🇴", continent:"Asie", coords:"31.9539°N, 35.9106°E", funFact:"Amman est construite sur 7 collines comme Rome. La ville est la base idéale pour visiter Pétra, la cité rose nabatéenne classée merveille du monde.", costs:{logement:450,courses:85,restos:60,nocturne:48,transport:15,sante:28,telecom:10,voyage:165}, safety:72, english:3 },
  { id:576, name:"Osaka", country:"Japon", flag:"🇯🇵", continent:"Asie", coords:"34.6937°N, 135.5023°E", funFact:"Osaka est surnommée la cuisine du Japon — les habitants y dépensent plus en nourriture que dans toute autre ville japonaise. L'expression kuidaore (se ruiner en mangeant) y est née.", costs:{logement:850,courses:158,restos:148,nocturne:105,transport:90,sante:52,telecom:33,voyage:285}, safety:88, english:2 },
  { id:577, name:"Kyoto", country:"Japon", flag:"🇯🇵", continent:"Asie", coords:"35.0116°N, 135.7681°E", funFact:"Kyoto était la capitale du Japon pendant 1 000 ans et a été délibérément épargnée lors des bombardements de la Seconde Guerre mondiale. La ville compte 1 600 temples et 17 sites UNESCO.", costs:{logement:800,courses:152,restos:142,nocturne:98,transport:85,sante:50,telecom:32,voyage:278}, safety:90, english:2 },
  { id:578, name:"Taipei", country:"Taïwan", flag:"🇹🇼", continent:"Asie", coords:"25.0330°N, 121.5654°E", funFact:"Taipei est la ville de street food la plus fascinante d'Asie. Le Taipei 101 a été le bâtiment le plus haut du monde de 2004 à 2010.", costs:{logement:780,courses:142,restos:125,nocturne:92,transport:72,sante:48,telecom:28,voyage:268}, safety:85, english:3 },
  { id:579, name:"Kuala Lumpur", country:"Malaisie", flag:"🇲🇾", continent:"Asie", coords:"3.1390°N, 101.6869°E", funFact:"Kuala Lumpur signifie confluence boueuse en malais. Les tours Petronas sont les tours jumelles les plus hautes du monde. La ville est l'une des plus abordables d'Asie du Sud-Est.", costs:{logement:520,courses:95,restos:68,nocturne:58,transport:25,sante:35,telecom:12,voyage:220}, safety:65, english:4 },
  { id:580, name:"Ho Chi Minh-Ville", country:"Viêt Nam", flag:"🇻🇳", continent:"Asie", coords:"10.8231°N, 106.6297°E", funFact:"Ho Chi Minh-Ville (anciennement Saïgon) est le moteur économique du Viêt Nam. La ville compte 8 millions de motos — traverser une rue est un art.", costs:{logement:380,courses:68,restos:45,nocturne:40,transport:10,sante:22,telecom:7,voyage:185}, safety:62, english:3 },
  { id:581, name:"Hanoï", country:"Viêt Nam", flag:"🇻🇳", continent:"Asie", coords:"21.0285°N, 105.8542°E", funFact:"Hanoï est l'une des capitales les plus anciennes d'Asie du Sud-Est fondée en 1010. Chaque matin à 6h des milliers de Vietnamiens pratiquent le tai-chi autour du lac Hoan Kiem.", costs:{logement:350,courses:62,restos:42,nocturne:35,transport:9,sante:20,telecom:7,voyage:180}, safety:65, english:2 },
  { id:582, name:"Auckland", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"36.8509°S, 174.7645°E", funFact:"Auckland est construite sur 53 volcans éteints — la ville entière est un champ volcanique unique. La Nouvelle-Zélande a été le premier pays au monde à accorder le droit de vote aux femmes en 1893.", costs:{logement:1100,courses:172,restos:148,nocturne:102,transport:90,sante:70,telecom:38,voyage:280}, safety:82, english:6 },
  { id:583, name:"Wellington", country:"Nouvelle-Zélande", flag:"🇳🇿", continent:"Océanie", coords:"41.2865°S, 174.7762°E", funFact:"Wellington est la capitale la plus ventée du monde. Peter Jackson y a filmé toute la trilogie du Seigneur des Anneaux.", costs:{logement:1000,courses:165,restos:142,nocturne:95,transport:85,sante:68,telecom:36,voyage:270}, safety:83, english:6 },
  { id:584, name:"Melbourne", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"37.8136°S, 144.9631°E", funFact:"Melbourne est régulièrement classée ville la plus agréable à vivre au monde et est la capitale mondiale du café flat white. Ses ruelles de street art sont mondialement reconnues.", costs:{logement:1200,courses:178,restos:162,nocturne:115,transport:105,sante:75,telecom:38,voyage:320}, safety:82, english:6 },
  { id:585, name:"Brisbane", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"27.4698°S, 153.0251°E", funFact:"Brisbane est la ville hôte des Jeux Olympiques 2032. La ville offre 283 jours de soleil par an et est la porte d'entrée de la Gold Coast.", costs:{logement:1100,courses:170,restos:155,nocturne:108,transport:95,sante:72,telecom:37,voyage:305}, safety:82, english:6 },
  { id:586, name:"Perth", country:"Australie", flag:"🇦🇺", continent:"Océanie", coords:"31.9505°S, 115.8605°E", funFact:"Perth est la ville la plus isolée du monde — la ville la plus proche est Adélaïde à 2 700 km. Elle reçoit plus d'heures de soleil que n'importe quelle autre ville australienne.", costs:{logement:1050,courses:168,restos:150,nocturne:105,transport:90,sante:70,telecom:37,voyage:310}, safety:82, english:6 },
  { id:587, name:"Reykjavik", country:"Islande", flag:"🇮🇸", continent:"Europe", coords:"64.1466°N, 21.9426°O", funFact:"Reykjavik fonctionne à 100% aux énergies géothermiques. C'est le meilleur endroit au monde pour observer les aurores boréales en milieu urbain.", costs:{logement:1100,courses:195,restos:188,nocturne:150,transport:80,sante:60,telecom:28,voyage:280}, safety:92, english:6 },
  { id:588, name:"Bergen", country:"Norvège", flag:"🇳🇴", continent:"Europe", coords:"60.3913°N, 5.3221°E", funFact:"Bergen est la porte des fjords norvégiens. La ville reçoit 240 jours de pluie par an — les habitants disent que la pluie est leur soleil.", costs:{logement:1100,courses:182,restos:172,nocturne:130,transport:92,sante:58,telecom:28,voyage:255}, safety:80, english:6 },
  { id:589, name:"Göteborg", country:"Suède", flag:"🇸🇪", continent:"Europe", coords:"57.7089°N, 11.9746°E", funFact:"Göteborg est la capitale des fruits de mer de Scandinavie. La ville est le siège de Volvo et Hasselblad.", costs:{logement:950,courses:162,restos:152,nocturne:115,transport:88,sante:54,telecom:26,voyage:232}, safety:78, english:6 },
  { id:590, name:"Copenhague", country:"Danemark", flag:"🇩🇰", continent:"Europe", coords:"55.6761°N, 12.5683°E", funFact:"Copenhague est la capitale du vélo — 62% des habitants s'y déplacent à vélo quotidiennement. Le Danemark est le pays le plus heureux du monde selon le World Happiness Report.", costs:{logement:1200,courses:185,restos:178,nocturne:140,transport:95,sante:58,telecom:30,voyage:248}, safety:82, english:6 },
  { id:591, name:"Édimbourg", country:"Royaume-Uni", flag:"🇬🇧", continent:"Europe", coords:"55.9533°N, 3.1883°O", funFact:"Édimbourg abrite le plus grand festival des arts du monde — le Edinburgh Fringe avec 50 000 représentations en 3 semaines. Son château trône sur un volcan éteint.", costs:{logement:900,courses:148,restos:135,nocturne:100,transport:75,sante:52,telecom:25,voyage:185}, safety:70, english:6 },
  { id:592, name:"Dublin", country:"Irlande", flag:"🇮🇪", continent:"Europe", coords:"53.3498°N, 6.2603°O", funFact:"Dublin est la capitale avec le plus de prix Nobel de littérature par habitant — Yeats, Beckett, Shaw et Heaney. La bibliothèque Trinity College abrite le Livre de Kells enluminé en 800 ap. J.-C.", costs:{logement:1250,courses:168,restos:155,nocturne:115,transport:88,sante:55,telecom:28,voyage:192}, safety:72, english:6 },
  { id:593, name:"Helsinki", country:"Finlande", flag:"🇫🇮", continent:"Europe", coords:"60.1699°N, 24.9384°E", funFact:"Helsinki possède le plus grand nombre de saunas par habitant au monde — 3,3 millions de saunas pour 5,5 millions de Finlandais. C'est la capitale mondiale du design nordique.", costs:{logement:1050,courses:172,restos:162,nocturne:122,transport:88,sante:55,telecom:26,voyage:238}, safety:85, english:6 },
  { id:594, name:"Tallinn", country:"Estonie", flag:"🇪🇪", continent:"Europe", coords:"59.4370°N, 24.7536°E", funFact:"L'Estonie est la nation la plus numérique au monde — vote électronique disponible. Skype y a été inventé. Tallinn est la Silicon Valley de l'Europe de l'Est.", costs:{logement:500,courses:89,restos:67,nocturne:55,transport:24,sante:30,telecom:13,voyage:120}, safety:75, english:5 },
  { id:595, name:"Riga", country:"Lettonie", flag:"🇱🇻", continent:"Europe", coords:"56.9496°N, 24.1052°E", funFact:"Riga possède le plus grand ensemble de bâtiments Art Nouveau au monde — 800 édifices représentant un tiers du centre-ville entier.", costs:{logement:450,courses:84,restos:63,nocturne:50,transport:22,sante:28,telecom:12,voyage:110}, safety:70, english:5 },
  { id:596, name:"Ljubljana", country:"Slovénie", flag:"🇸🇮", continent:"Europe", coords:"46.0569°N, 14.5058°E", funFact:"Ljubljana a été élue capitale verte européenne en 2016. Son centre-ville est entièrement interdit aux voitures depuis 2007 — un modèle mondial.", costs:{logement:650,courses:108,restos:79,nocturne:60,transport:28,sante:35,telecom:15,voyage:130}, safety:78, english:5 },
  { id:597, name:"Zagreb", country:"Croatie", flag:"🇭🇷", continent:"Europe", coords:"45.8150°N, 15.9819°E", funFact:"Zagreb abrite le Musée des Relations Rompues — des objets laissés par des ex-amoureux du monde entier. La cravate a été inventée en Croatie au 17ème siècle.", costs:{logement:580,courses:98,restos:72,nocturne:58,transport:28,sante:32,telecom:14,voyage:128}, safety:72, english:4 },
  { id:598, name:"Sarajevo", country:"Bosnie-Herzégovine", flag:"🇧🇦", continent:"Europe", coords:"43.8563°N, 18.4131°E", funFact:"Sarajevo est la seule ville européenne à avoir organisé les Jeux Olympiques d'hiver (1984) et subi un siège militaire (1992-1995). Surnommée le Jérusalem des Balkans.", costs:{logement:400,courses:80,restos:55,nocturne:45,transport:15,sante:25,telecom:11,voyage:115}, safety:60, english:3 },
  { id:599, name:"Tirana", country:"Albanie", flag:"🇦🇱", continent:"Europe", coords:"41.3275°N, 19.8187°E", funFact:"Tirana est la capitale la plus colorée d'Europe — le maire Edi Rama a fait peindre tous les immeubles en couleurs vives pour lutter contre la grisaille du communisme.", costs:{logement:350,courses:70,restos:48,nocturne:40,transport:10,sante:20,telecom:9,voyage:110}, safety:62, english:3 },
  { id:600, name:"Nicosie", country:"Chypre", flag:"🇨🇾", continent:"Europe", coords:"35.1856°N, 33.3823°E", funFact:"Nicosie est la dernière capitale divisée du monde — une ligne verte de l'ONU sépare la partie grecque de la partie turque depuis 1974.", costs:{logement:650,courses:112,restos:85,nocturne:68,transport:32,sante:40,telecom:18,voyage:138}, safety:70, english:4 },
  { id:601, name:"Valette", country:"Malte", flag:"🇲🇹", continent:"Europe", coords:"35.8997°N, 14.5147°E", funFact:"Valette est la plus petite capitale de l'Union Européenne avec seulement 6 000 habitants. La ville entière est classée UNESCO — chaque rue est un musée à ciel ouvert.", costs:{logement:700,courses:118,restos:92,nocturne:72,transport:25,sante:38,telecom:18,voyage:142}, safety:72, english:5 },
  { id:602, name:"Chisinau", country:"Moldavie", flag:"🇲🇩", continent:"Europe", coords:"47.0105°N, 28.8638°E", funFact:"Chisinau est la capitale la moins chère d'Europe. La Moldavie produit certains des meilleurs vins du monde dans ses caves Mileștii Mici — 200 km de galeries souterraines.", costs:{logement:280,courses:52,restos:35,nocturne:28,transport:8,sante:15,telecom:7,voyage:100}, safety:60, english:2 },
  { id:603, name:"Tachkent", country:"Ouzbékistan", flag:"🇺🇿", continent:"Asie", coords:"41.2995°N, 69.2401°E", funFact:"Tachkent est la plus grande ville d'Asie centrale. La ville est la porte de la Route de la Soie avec les villes légendaires Samarcande et Boukhara à quelques heures.", costs:{logement:250,courses:50,restos:32,nocturne:25,transport:6,sante:14,telecom:6,voyage:148}, safety:62, english:1 },
  { id:604, name:"Samarcande", country:"Ouzbékistan", flag:"🇺🇿", continent:"Asie", coords:"39.6542°N, 66.9597°E", funFact:"Samarcande est l'une des plus anciennes villes du monde. La place du Régistan avec ses 3 madrasas couvertes de faïences bleues est parmi les ensembles architecturaux les plus beaux du monde.", costs:{logement:200,courses:42,restos:28,nocturne:20,transport:5,sante:12,telecom:5,voyage:145}, safety:65, english:1 },
  { id:605, name:"Almaty", country:"Kazakhstan", flag:"🇰🇿", continent:"Asie", coords:"43.2220°N, 76.8512°E", funFact:"Almaty signifie Père des pommes — la ville est le berceau génétique de toutes les pommes du monde. Les pommiers sauvages du Tian Shan kazakh sont les ancêtres de toutes les variétés cultivées.", costs:{logement:380,courses:72,restos:50,nocturne:42,transport:12,sante:24,telecom:9,voyage:185}, safety:65, english:2 },
  { id:606, name:"Muscat", country:"Oman", flag:"🇴🇲", continent:"Asie", coords:"23.5859°N, 58.4059°E", funFact:"Muscat est l'une des capitales les plus propres et sûres du Moyen-Orient. L'Oman est le pays le plus ouvert et tolérant de la péninsule arabique.", costs:{logement:700,courses:115,restos:82,nocturne:55,transport:35,sante:42,telecom:18,voyage:240}, safety:82, english:3 },
];
...
// ── CATEGORY PANEL ──
function CategoryPanel({activeKeys,setActiveKeys,extraCost,setExtraCost,extraLabel,setExtraLabel,t,darkMode=true}){
  const dm=darkMode;
...
// ── HOLD-TO-REPEAT HOOK ──
function useHoldStep(set,dir){
  const intervalRef=useRef(null);
  const timeoutRef=useRef(null);
  const start=useCallback(()=>{
    set(v=>Math.max(0,v+dir));
            ...
            return(
              <div key={city.id} style={{display:"grid",gridTemplateColumns:"2fr 1fr 2fr 1fr",gap:8,padding:"10px 16px",borderBottom:"1px solid rgba(255,255,255,0.04)",alignItems:"center",transition:"background 0.15s",cursor:"default"}}
                ...
                <div style={{display:"flex",alignItems:"center",gap:8}}>
                  ...
                  <div>
                    <div style={{fontSize:13,fontWeight:600,color:darkMode?"#f7fafc":"#1a202c"}}>{city.name}</div>
...
export default function App(){
  ...
  const[battleSlots,setBattleSlots]=useState([CITIES[0],CITIES[1]]);
  ...
  },[battleMode,activeSlot,battleSlots,isMobile]);
    ...
    <div style={{minHeight:"100vh",background:darkMode?"#0d1117":"#f0f4f8",fontFamily:"'DM Sans',-apple-system,sans-serif",color:darkMode?"#f7fafc":"#1a202c",transition:"background 0.3s,color 0.3s"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        input{color:inherit;} input::placeholder{color:#4a5568;} button,select{font-family:'DM Sans',sans-serif;}
      ...
      {/* ── BATTLE SELECT BAR ── */}
      {battleMode&&(
        <div style={{background:"rgba(255,107,53,0.05)",borderBottom:"1px solid rgba(255,107,53,0.16)",padding:"8px 14px"}}>
          <div style={{maxWidth:1400,margin:"0 auto",display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
            <span style={{fontSize:11,color:"#a0aec0",flexShrink:0}}>⚔️ Battle :</span>
            {battleSlots.map((city,i)=>{
              const colors=["#FF6B35","#5B8DEF","#a78bfa"];
          ...
          <div style={{display:"flex",flexDirection:isMobile?"column":"row",gap:18,alignItems:"flex-start"}}>
            ...
            <div style={{width:isMobile?"100%":300,flexShrink:0,display:"flex",flexDirection:"column",gap:10,order:isMobile&&battleMode?2:0}}>
              ...
              <div style={{position:"relative"}}>
                ...
                <input value={search} onChange={e=>setSearch(e.target.value)} placeholder={t.search} style={{width:"100%",padding:"9px 10px 9px 32px",background:darkMode?"rgba(255,255,255,0.04)":"rgba(0,0,0,0.04)",border:darkMode?"1px solid rgba(255,255,255,0.07)":"1px solid rgba(0,0,0,0.12)",borderRadius:9,color:darkMode?"#f7fafc":"#1a202c",fontSize:13,outline:"none"}} onFocus={e=>e.target.style.borderColor="rgba(255,107,53,0.4)"} onBlur={e=>e.target.style.borderColor="rgba(255,255,255,0.07)"}/>
              </div>
              ...
              {showFilters&&<CategoryPanel activeKeys={activeKeys} setActiveKeys={setActiveKeys} extraCost={extraCost} setExtraCost={setExtraCost} extraLabel={extraLabel} setExtraLabel={setExtraLabel} t={t} darkMode={darkMode}/>}
              ...
              <div style={{display:"flex",flexDirection:"column",gap:5,maxHeight:isMobile?(battleMode?160:240):"calc(100vh - 440px)",overflowY:"auto",paddingRight:2}}>
                {filtered.map(city=>{
                  const total=calcTotal(city,preset,activeKeys,extraCost);
                  const slotIdx=battleMode?battleSlots.findIndex(s=>s.id===city.id):-1;
                  const isInBattle=slotIdx>=0;
                  const isSel=battleMode?isInBattle:city.id===selectedCity.id;
                  const slotColors=["#FF6B35","#5B8DEF","#a78bfa"];
                  ...
                  return(
                    <div key={city.id} onClick={()=>handleCityClick(city)} style={{padding:"8px 12px",borderRadius:9,background:isSel?`${ac}14`:darkMode?"rgba(255,255,255,0.02)":"rgba(0,0,0,0.04)",border:`1px solid ${isSel?`${ac}45`:darkMode?"rgba(255,255,255,0.05)":"rgba(0,0,0,0.1)"}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",transition:"all 0.15s"}}>
                      ...
                      <div style={{textAlign:"right"}}>
                        ...
                        {battleMode&&isInBattle&&<div style={{fontSize:9,color:ac,fontWeight:700,marginTop:2}}>{slotIdx===0?"A":slotIdx===1?"B":"C"}</div>}
                      </div>
                    </div>
                  );
                })}
            ...
            <div ref={detailRef} style={{flex:1,minWidth:0,background:darkMode?"rgba(255,255,255,0.02)":"rgba(255,255,255,0.9)",border:darkMode?"1px solid rgba(255,255,255,0.06)":"1px solid rgba(0,0,0,0.1)",borderRadius:16,padding:isMobile?12:24,...(isMobile?{scrollMarginTop:80,order:isMobile&&battleMode?1:0}:{})}}>
              ...
              {battleMode
                ?<BattleView cities={battleSlots} preset={preset} isMobile={isMobile} activeKeys={activeKeys} extraCost={extraCost} t={t} lang={lang} darkMode={darkMode}/>
